...
public class LocalizedStringData
{
	...
	[CanBeNull]
	[JsonProperty(PropertyName = "void", DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
	[JsonConverter(typeof(StringOrArrayConverter))]
	public List<string> VoId;

	[JsonProperty(PropertyName = "spammable", DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
	...
	public bool TryGetText(Locale locale, out string text)
	{
		...
		text = locale2?.Text ?? "";
		if (locale2 != null && locale2.Text != null)
		{
