...
public class TraitData
{
	...
	[NotNull]
	[JsonProperty(PropertyName = "speaker", DefaultValueHandling = DefaultValueHandling.Ignore)]
	public string Speaker;

	[NotNull]
	[JsonProperty(PropertyName = "speaker_gender", DefaultValueHandling = DefaultValueHandling.Ignore)]
