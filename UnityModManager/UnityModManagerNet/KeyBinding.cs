...
public class KeyBinding
{
	...
	public static bool Ctrl()
	{
		if (LegacyInputDisabled)
		{
			if (!hasErrors)
			{
				return (bool)isPressedPI.GetValue(keyControlCtrl, null);
			}
			return false;
		}
	...
	public static bool Shift()
	{
		if (LegacyInputDisabled)
		{
			if (!hasErrors)
			{
				return (bool)isPressedPI.GetValue(keyControlShift, null);
			}
			return false;
		}
	...
	public static bool Alt()
	{
		if (LegacyInputDisabled)
		{
			if (!hasErrors)
			{
				return (bool)isPressedPI.GetValue(keyControlAlt, null);
			}
			return false;
		}
	...
	public bool Pressed()
	{
		...
		if (LegacyInputDisabled)
		{
			if (!hasErrors && flag && KeyControl != KeyControlZero)
			{
				return (bool)isPressedPI.GetValue(KeyControl, null);
			}
			return false;
		}
		if (flag)
	...
	public bool Down()
	{
		...
		if (LegacyInputDisabled)
		{
			if (!hasErrors && flag && KeyControl != KeyControlZero)
			{
				return (bool)wasPressedThisFramePI.GetValue(KeyControl, null);
			}
			return false;
		}
		if (flag)
	...
	public bool Up()
	{
		...
		if (LegacyInputDisabled)
		{
			if (!hasErrors && flag && KeyControl != KeyControlZero)
			{
				return (bool)wasReleasedThisFramePI.GetValue(KeyControl, null);
			}
			return false;
		}
		if (flag)
