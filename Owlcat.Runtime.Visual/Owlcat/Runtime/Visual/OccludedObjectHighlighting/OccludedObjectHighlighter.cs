...
public class OccludedObjectHighlighter : MonoBehaviour, IInvasiveLinkedListNode<OccludedObjectHighlighter>
{
	...
	internal static InvasiveLinkedList<OccludedObjectHighlighter> Instances;
	...
	OccludedObjectHighlighter IInvasiveLinkedListNode<OccludedObjectHighlighter>.Prev { get; set; }

	OccludedObjectHighlighter IInvasiveLinkedListNode<OccludedObjectHighlighter>.Next { get; set; }
