...
public class IndirectMeshComponent : MonoBehaviour, IIndirectMesh
{
	...
	public void SetMeshInstances(IndirectRenderingSystem indirectRenderingSystem)
	{
		throw new NotImplementedException();
	}

	public void CopyTo(NativeList<IndirectInstanceData> instanceData, NativeList<GPUDrivenInstanceID> instanceIds)
	{
		throw new NotImplementedException();
	}
}
