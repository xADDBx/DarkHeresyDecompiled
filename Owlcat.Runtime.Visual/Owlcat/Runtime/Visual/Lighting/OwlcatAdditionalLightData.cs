...
public class OwlcatAdditionalLightData : MonoBehaviour, IAdditionalData
{
	...
	public bool ColoredShadows
	{
		get
		{
			return m_ColoredShadows;
		}
		set
		{
			m_ColoredShadows = value;
		}
	}
