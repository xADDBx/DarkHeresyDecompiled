...
public class LightCookieManager : IDisposable
{
	...
	private sealed class LightCookiePass : ScriptableRenderPass
	{
		...
		{
			PassData passData;
			using RenderGraphBuilder renderGraphBuilder = frameData.Get<WaaaghRenderingData>().RenderGraph.AddRenderPass<PassData>(Name, out passData, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Lighting\\LightCookieManager.cs", 412);
