...
public class LightCookieManager : IDisposable
{
	...
	private sealed class LightCookiePass : ScriptableRenderPass
	{
		...
		{
			PassData passData;
			using RenderGraphBuilder renderGraphBuilder = frameData.Get<WaaaghRenderingData>().RenderGraph.AddRenderPass<PassData>(Name, out passData, ".\\Library\\PackageCache\\com.owlcat.visual@f3d4bf622f68\\Runtime\\Lighting\\LightCookieManager.cs", 412);
