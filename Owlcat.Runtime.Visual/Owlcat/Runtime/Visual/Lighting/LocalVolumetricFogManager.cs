...
public class LocalVolumetricFogManager
{
	...
	public void RegisterVolume(LocalVolumetricFog volume)
	{
		...
		if (SystemInfo.IsFormatSupported(m_LocalVolumetricFogAtlasFormat, GraphicsFormatUsage.LoadStore) && volume.Parameters.VolumeMask != null && VolumeAtlas != null && VolumeAtlas.IsTextureValid(volume.Parameters.VolumeMask))
		{
			AddTextureIntoAtlas(volume.Parameters.VolumeMask);
		}
	}
	...
	public void DeRegisterVolume(LocalVolumetricFog volume)
	{
		...
		if (SystemInfo.IsFormatSupported(m_LocalVolumetricFogAtlasFormat, GraphicsFormatUsage.LoadStore) && volume.Parameters.VolumeMask != null && m_VolumeAtlas != null)
		{
