...
public static class TemporalAA
{
	...
	internal static void Render(RenderGraph renderGraph, Material taaMaterial, WaaaghCameraData cameraData, ref TextureHandle srcColor, ref TextureHandle srcDepth, ref TextureHandle srcMotionVectors, ref TextureHandle dstColor)
	{
		...
		using (IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<TaaPassData>("Temporal Anti-aliasing", out passData, ProfilingSampler.Get(WaaaghProfileId.TAA), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\TemporalAA.cs", 413))
		{
		...
		using (IRasterRenderGraphBuilder rasterRenderGraphBuilder2 = renderGraph.AddRasterRenderPass<TaaPassData>("Temporal Anti-aliasing Copy History", out passData2, ProfilingSampler.Get(WaaaghProfileId.TAACopyHistory), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\TemporalAA.cs", 472))
		{
