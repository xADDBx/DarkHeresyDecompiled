...
public abstract class ScriptableRenderer : IDisposable
{
	...
	public void Execute(ScriptableRenderContext context, ContextContainer frameData)
	{
		...
		using (new ProfilingScope(ProfilingSampler.Get(WaaaghProfileId.RendererRecordRenderGraph)))
		{
			...
			renderGraph.BeginProfilingSampler(TryGetOrAddCameraSampler(camera), ".\\Library\\PackageCache\\com.owlcat.visual@141c9a01de77\\Runtime\\Waaagh\\ScriptableRenderer.cs", 301);
			...
			renderGraph.EndProfilingSampler(TryGetOrAddCameraSampler(camera), ".\\Library\\PackageCache\\com.owlcat.visual@141c9a01de77\\Runtime\\Waaagh\\ScriptableRenderer.cs", 333);
		}
