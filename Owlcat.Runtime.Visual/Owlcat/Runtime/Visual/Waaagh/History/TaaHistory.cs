...
public sealed class TaaHistory : WaaaghHistoryItem
{
	...
	{
		AllocHistory(m_TaaAccumulationTextureIds[0], 1, ref desc, m_TaaAccumulationNames[0]);
		if (xrMultipassEnabled)
		{
			AllocHistory(m_TaaAccumulationTextureIds[1], 1, ref desc, m_TaaAccumulationNames[1]);
		}
		m_Descriptor = desc;
