...
public class WaaaghCameraHistory : ICameraHistoryReadAccess, ICameraHistoryWriteAccess, IPerFrameHistoryAccessTracker, IDisposable
{
	...
	private int m_LastFrameRequested;

	public int LastFrameRequested => m_LastFrameRequested;
	...
	public void RequestAccess<Type>() where Type : ContextItem
	{
		...
		m_LastFrameRequested = FrameId.FrameCount;
	}
