...
public static class ShaderPropertyId
{
	...
	public static readonly int custom_SpecCube0 = Shader.PropertyToID("custom_SpecCube0");

	public static readonly int custom_SpecCube0_HDR = Shader.PropertyToID("custom_SpecCube0_HDR");

	public static readonly int custom_SpecCube0_ProbePosition = Shader.PropertyToID("custom_SpecCube0_ProbePosition");

	public static readonly int custom_SpecCube0_BoxMin = Shader.PropertyToID("custom_SpecCube0_BoxMin");

	public static readonly int custom_SpecCube0_BoxMax = Shader.PropertyToID("custom_SpecCube0_BoxMax");
	...
	public static int _DebugVTTiles = Shader.PropertyToID("_DebugVTTiles");

	public static int _DebugVTTilesSliceIndex = Shader.PropertyToID("_DebugVTTilesSliceIndex");

	public static int _DebugTerrainMode = Shader.PropertyToID("_DebugTerrainMode");

	public static int _DebugTerrainGradientMinColor = Shader.PropertyToID("_DebugTerrainGradientMinColor");

	public static int _DebugTerrainGradientMaxColor = Shader.PropertyToID("_DebugTerrainGradientMaxColor");

	public static int _DebugTerrainBackColor = Shader.PropertyToID("_DebugTerrainBackColor");

	public static int _DebugTerrainOpacity = Shader.PropertyToID("_DebugTerrainOpacity");

	public static int _DebugTerrainLayerIndex = Shader.PropertyToID("_DebugTerrainLayerIndex");

	public static int _DebugTerrainLayerWeightMin = Shader.PropertyToID("_DebugTerrainLayerWeightMin");

	public static int _DebugTerrainLayerWeightMax = Shader.PropertyToID("_DebugTerrainLayerWeightMax");

	public static int _DebugTerrainPvsHeatmapCountThreshold = Shader.PropertyToID("_DebugTerrainPvsHeatmapCountThreshold");

	public static int _DebugTerrainSplatMapWeightMaskShape = Shader.PropertyToID("_DebugTerrainSplatMapWeightMaskShape");

	public static readonly int _HDROutputLuminanceParams = Shader.PropertyToID("_HDROutputLuminanceParams");

	public static readonly int _HDROutputGradingParams = Shader.PropertyToID("_HDROutputGradingParams");

	public static readonly int _GlobalDitheringTexture = Shader.PropertyToID("_GlobalDitheringTexture");

	public static readonly int _GlobalDitheringParams = Shader.PropertyToID("_GlobalDitheringParams");
}
