...
public class DebugDisplaySettingsShadows : IDebugDisplaySettingsData, IDebugDisplaySettingsQuery
{
	...
	public bool AreAnySettingsActive
	{
		get
		{
			if (DebugAtlasOccupancy == DebugShadowBufferType.None)
			{
				return DebugViewAtlas != DebugShadowBufferType.None;
			}
			return true;
		}
	}
