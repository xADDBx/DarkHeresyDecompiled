...
public static class WaaaghRenderQueue
{
	public enum Priority
	{
		...
		Opaque = 2000,
		OpaqueLast = 2399,
		OpaqueAlphaTest = 2400,
		OpaqueAlphaTestLast = 2500,
	...
	public static readonly RenderQueueRange Opaque = new RenderQueueRange(0, 2399);

	public static readonly RenderQueueRange OpaqueAlphaTest = new RenderQueueRange(2400, 2500);
