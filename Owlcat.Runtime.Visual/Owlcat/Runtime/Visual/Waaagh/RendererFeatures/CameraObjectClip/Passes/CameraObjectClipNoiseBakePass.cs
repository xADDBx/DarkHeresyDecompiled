...
public class CameraObjectClipNoiseBakePass : ScriptableRenderPass<CameraObjectClipNoiseBakePassData>
{
	...
	protected override void Setup(RenderGraphBuilder builder, CameraObjectClipNoiseBakePassData data, ContextContainer frameData)
	{
		WaaaghRenderingData waaaghRenderingData = frameData.Get<WaaaghRenderingData>();
		data.NoiseBakeMaterial = m_NoiseBakeMaterial;
		TextureHandle input = waaaghRenderingData.RenderGraph.ImportTexture(m_Feature.Noise3D);
