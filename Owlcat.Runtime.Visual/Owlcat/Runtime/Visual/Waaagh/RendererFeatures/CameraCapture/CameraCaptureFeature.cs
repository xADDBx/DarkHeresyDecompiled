...
public sealed class CameraCaptureFeature : ScriptableRendererFeature
{
	...
	private sealed class CapturePass : ScriptableRenderPass
	{
		...
		public override void RecordRenderGraph(ContextContainer frameData)
		{
			...
			Results.Clear();
			PassData passData;
			RenderGraphBuilder renderGraphBuilder = renderGraph.AddRenderPass<PassData>(Name, out passData, ".\\Library\\PackageCache\\com.owlcat.visual@f3d4bf622f68\\Runtime\\Waaagh\\RendererFeatures\\CameraCapture\\CameraCaptureFeature.cs", 299);
			try
			{
