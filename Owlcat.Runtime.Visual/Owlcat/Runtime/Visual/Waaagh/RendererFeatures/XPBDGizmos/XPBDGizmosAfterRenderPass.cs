...
public class XPBDGizmosAfterRenderPass : ScriptableRenderPass
{
	...
	{
		PassData passData;
		using RenderGraphBuilder builder = renderGraph.AddRenderPass<PassData>("XPBD Gizmos Particles", out passData, ProfilingSampler.Get(XPBDGizmosProfileId.XPBDGizmosParticles), ".\\Library\\PackageCache\\com.owlcat.visual@141c9a01de77\\Runtime\\Waaagh\\RendererFeatures\\XPBDGizmos\\Passes\\XPBDGizmosAfterRenderPass.cs", 249);
		passData.Solver = Owlcat.Runtime.Visual.XPBD.XPBD.Solver;
		passData.Gizmos = Owlcat.Runtime.Visual.XPBD.XPBD.Solver.SolverImpl.GizmosImpl;
		passData.GizmosMaterial = m_Feature.GizmosMaterial;
	...
	{
		PassData passData;
		using RenderGraphBuilder builder = renderGraph.AddRenderPass<PassData>("XPBD Gizmos Velocities", out passData, ProfilingSampler.Get(XPBDGizmosProfileId.XPBDGizmosVelocities), ".\\Library\\PackageCache\\com.owlcat.visual@141c9a01de77\\Runtime\\Waaagh\\RendererFeatures\\XPBDGizmos\\Passes\\XPBDGizmosAfterRenderPass.cs", 278);
		passData.Solver = Owlcat.Runtime.Visual.XPBD.XPBD.Solver;
		passData.Gizmos = Owlcat.Runtime.Visual.XPBD.XPBD.Solver.SolverImpl.GizmosImpl;
		passData.GizmosMaterial = m_Feature.GizmosMaterial;
	...
	{
		PassData passData;
		using RenderGraphBuilder builder = renderGraph.AddRenderPass<PassData>("XPBD Gizmos Normals", out passData, ProfilingSampler.Get(XPBDGizmosProfileId.XPBDGizmosDrawNormals), ".\\Library\\PackageCache\\com.owlcat.visual@141c9a01de77\\Runtime\\Waaagh\\RendererFeatures\\XPBDGizmos\\Passes\\XPBDGizmosAfterRenderPass.cs", 509);
		passData.Solver = Owlcat.Runtime.Visual.XPBD.XPBD.Solver;
		passData.Gizmos = Owlcat.Runtime.Visual.XPBD.XPBD.Solver.SolverImpl.GizmosImpl;
		passData.GizmosMaterial = m_Feature.GizmosMaterial;
	...
	{
		PassData passData;
		using RenderGraphBuilder builder = renderGraph.AddRenderPass<PassData>("XPBD Gizmos Rest Normals", out passData, ProfilingSampler.Get(XPBDGizmosProfileId.XPBDGizmosDrawRestNormals), ".\\Library\\PackageCache\\com.owlcat.visual@141c9a01de77\\Runtime\\Waaagh\\RendererFeatures\\XPBDGizmos\\Passes\\XPBDGizmosAfterRenderPass.cs", 536);
		passData.Solver = Owlcat.Runtime.Visual.XPBD.XPBD.Solver;
		passData.Gizmos = Owlcat.Runtime.Visual.XPBD.XPBD.Solver.SolverImpl.GizmosImpl;
		passData.GizmosMaterial = m_Feature.GizmosMaterial;
		passData.PassIndex = m_PassNormals;
	...
	{
		PassData passData;
		using RenderGraphBuilder builder = renderGraph.AddRenderPass<PassData>("XPBD Gizmos Deformed Vertices", out passData, ProfilingSampler.Get(XPBDGizmosProfileId.XPBDGizmosDrawDeformedVertices), ".\\Library\\PackageCache\\com.owlcat.visual@141c9a01de77\\Runtime\\Waaagh\\RendererFeatures\\XPBDGizmos\\Passes\\XPBDGizmosAfterRenderPass.cs", 563);
		passData.Solver = Owlcat.Runtime.Visual.XPBD.XPBD.Solver;
		passData.Gizmos = Owlcat.Runtime.Visual.XPBD.XPBD.Solver.SolverImpl.GizmosImpl;
		passData.GizmosMaterial = m_Feature.GizmosMaterial;
	...
	{
		PassData passData;
		using RenderGraphBuilder builder = renderGraph.AddRenderPass<PassData>("XPBD Gizmos Simplex Contacts", out passData, ProfilingSampler.Get(XPBDGizmosProfileId.XPBDGizmosDrawSimplexContacts), ".\\Library\\PackageCache\\com.owlcat.visual@141c9a01de77\\Runtime\\Waaagh\\RendererFeatures\\XPBDGizmos\\Passes\\XPBDGizmosAfterRenderPass.cs", 588);
		passData.Solver = Owlcat.Runtime.Visual.XPBD.XPBD.Solver;
		passData.Gizmos = Owlcat.Runtime.Visual.XPBD.XPBD.Solver.SolverImpl.GizmosImpl;
		passData.GizmosMaterial = m_Feature.GizmosMaterial;
