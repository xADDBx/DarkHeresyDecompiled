...
public class SetupProbeVolumesPass : ScriptableRenderPass
{
	...
	public override void RecordRenderGraph(ContextContainer frameData)
	{
		...
		PassData passData;
		using RenderGraphBuilder renderGraphBuilder = frameData.Get<WaaaghRenderingData>().RenderGraph.AddRenderPass<PassData>(Name, out passData, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\ProbeVolumes\\SetupProbeVolumesPass.cs", 27);
