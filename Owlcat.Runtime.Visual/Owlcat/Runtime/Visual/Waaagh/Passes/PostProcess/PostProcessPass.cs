...
public class PostProcessPass : ScriptableRenderPass
{
	...
	public override void RecordRenderGraph(ContextContainer frameData)
	{
		...
		waaaghRenderingData.RenderGraph.BeginProfilingSampler(sampler, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 360);
		if (num)
		{
		...
		waaaghRenderingData.RenderGraph.EndProfilingSampler(sampler, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 507);
	}
	...
	public void RenderStopNaN(RenderGraph renderGraph, RenderTextureDescriptor cameraTargetDescriptor, in TextureHandle activeCameraColor, out TextureHandle stopNaNTarget)
	{
		...
		using IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<StopNaNsPassData>("Stop NaNs", out passData, ProfilingSampler.Get(WaaaghProfileId.StopNaNs), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 528);
	...
	public void RenderSMAA(RenderGraph renderGraph, WaaaghResourceData resourceData, AntialiasingQuality antialiasingQuality, in TextureHandle source, out TextureHandle SMAATarget)
	{
		...
		using (IRasterRenderGraphBuilder rasterRenderGraphBuilder2 = renderGraph.AddRasterRenderPass<SMAAPassData>("SMAA Edge Detection", out passData2, ProfilingSampler.Get(WaaaghProfileId.SMAAEdgeDetection), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 643))
		{
		...
		using (IRasterRenderGraphBuilder rasterRenderGraphBuilder3 = renderGraph.AddRasterRenderPass<SMAAPassData>("SMAA Blend weights", out passData3, ProfilingSampler.Get(WaaaghProfileId.SMAABlendWeight), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 666))
		{
	...
	public void RenderDoFGaussian(RenderGraph renderGraph, WaaaghResourceData resourceData, WaaaghCameraData cameraData, in TextureHandle source, in TextureHandle destination, ref Material dofMaterial)
	{
		...
		using (IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<DoFGaussianSetupPassData>("Setup DoF passes", out passData, ProfilingSampler.Get(WaaaghProfileId.SetupDoF), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 764))
		{
		...
		using (IRasterRenderGraphBuilder rasterRenderGraphBuilder4 = renderGraph.AddRasterRenderPass<DoFGaussianPassData>("Depth of Field - Blur H", out passData4, ProfilingSampler.Get(WaaaghProfileId.DOFBlurH), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 866))
		{
		...
		using (IRasterRenderGraphBuilder rasterRenderGraphBuilder5 = renderGraph.AddRasterRenderPass<DoFGaussianPassData>("Depth of Field - Blur V", out passData5, ProfilingSampler.Get(WaaaghProfileId.DOFBlurV), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 889))
		{
	...
	public void RenderDoFBokeh(RenderGraph renderGraph, WaaaghResourceData resourceData, WaaaghCameraData cameraData, in TextureHandle source, in TextureHandle destination, ref Material dofMaterial)
	{
		...
		using (IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<DoFBokehSetupPassData>("Setup DoF passes", out passData, ProfilingSampler.Get(WaaaghProfileId.SetupDoF), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 967))
		{
		...
		using (IRasterRenderGraphBuilder rasterRenderGraphBuilder2 = renderGraph.AddRasterRenderPass<DoFBokehPassData>("Depth of Field - Compute CoC", out passData2, ProfilingSampler.Get(WaaaghProfileId.DOFComputeCOC), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 1028))
		{
			rasterRenderGraphBuilder2.SetRenderAttachment(input, 0);
			passData2.sourceTexture = source;
			rasterRenderGraphBuilder2.UseTexture(in source);
	...
	public void RenderMotionBlur(RenderGraph renderGraph, WaaaghResourceData resourceData, WaaaghCameraData cameraData, in TextureHandle source, out TextureHandle destination)
	{
		...
		using IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<MotionBlurPassData>("Motion Blur", out passData, ProfilingSampler.Get(WaaaghProfileId.MotionBlur), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 1232);
		rasterRenderGraphBuilder.AllowGlobalStateModification(value: true);
	...
	public void RenderRadialBlur(RenderGraph renderGraph, WaaaghResourceData resourceData, WaaaghCameraData cameraData, in TextureHandle source, out TextureHandle destination)
	{
		...
		using RenderGraphBuilder renderGraphBuilder = renderGraph.AddRenderPass<RadialBlurPassData>("Radial Blur", out passData2, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 1338);
	...
	public void UberPostSetupBloomPass(RenderGraph rendergraph, in TextureHandle bloomTexture, Material uberMaterial)
	{
		...
		using IRasterRenderGraphBuilder rasterRenderGraphBuilder = rendergraph.AddRasterRenderPass<UberSetupBloomPassData>("UberPost - UberPostSetupBloomPass", out passData, ProfilingSampler.Get(WaaaghProfileId.UberPostSetupBloomPass), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 1476);
	...
	public void RenderBloomTexture(RenderGraph renderGraph, in TextureHandle source, out TextureHandle destination, bool enableAlphaOutput)
	{
		...
		using IUnsafeRenderGraphBuilder unsafeRenderGraphBuilder = renderGraph.AddUnsafePass<BloomPassData>("Bloom", out passData, ProfilingSampler.Get(WaaaghProfileId.Bloom), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 1656);
	...
	private void RenderBloomEnhancedTexture(RenderGraph renderGraph, in TextureHandle source, out TextureHandle destination, bool isAlphaOutputEnabled)
	{
		...
		using RenderGraphBuilder renderGraphBuilder = renderGraph.AddRenderPass<BloomEnhancedPassData>("Bloom Enhanced", out passData2, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 1795);
		passData2.Source = renderGraphBuilder.ReadTexture(in source);
	...
	{
		UberSetupBloomPassData passData;
		using IRasterRenderGraphBuilder rasterRenderGraphBuilder = rendergraph.AddRasterRenderPass<UberSetupBloomPassData>("UberPost - UberPostSetupBloomPass", out passData, ProfilingSampler.Get(WaaaghProfileId.UberPostSetupBloomPass), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 1846);
	...
	private void UpdateCameraResolution(RenderGraph renderGraph, WaaaghCameraData cameraData, Vector2Int newCameraTargetSize)
	{
		...
		using IUnsafeRenderGraphBuilder unsafeRenderGraphBuilder = renderGraph.AddUnsafePass<UpdateCameraResolutionPassData>("Update Camera Resolution", out passData, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 1980);
	...
	public void RenderUberPost(RenderGraph renderGraph, WaaaghCameraData cameraData, WaaaghPostProcessingData postProcessingData, in TextureHandle sourceTexture, in TextureHandle destTexture, in TextureHandle lutTexture, in TextureHandle overlayUITexture, bool requireHDROutput, bool enableAlphaOutput)
	{
		...
		if (num)
		{
			...
			using (IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<UberPostPassData>("Postprocessing Uber Swap Copy", out passData, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 2523))
			{
		...
		using IRasterRenderGraphBuilder rasterRenderGraphBuilder2 = renderGraph.AddRasterRenderPass<UberPostPassData>("Postprocessing Uber Post Pass", out passData2, ProfilingSampler.Get(WaaaghProfileId.UberPost), ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\PostProcessPass.cs", 2541);
