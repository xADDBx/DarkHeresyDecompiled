...
public class FinalPostProcessPass : ScriptableRenderPass
{
	...
	public override void RecordRenderGraph(ContextContainer frameData)
	{
		...
		renderGraph.BeginProfilingSampler(sampler, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\FinalPostProcessPass.cs", 117);
		...
		renderGraph.EndProfilingSampler(sampler, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\FinalPostProcessPass.cs", 262);
	}
	...
	public void RenderFinalBlit(RenderGraph renderGraph, WaaaghCameraData cameraData, in TextureHandle source, in TextureHandle overlayUITexture, in TextureHandle postProcessingTarget, ref FinalBlitSettings settings)
	{
		...
		if (num)
		{
			...
			using (IRasterRenderGraphBuilder rasterRenderGraphBuilder = renderGraph.AddRasterRenderPass<PostProcessingFinalBlitPassData>("Postprocessing Final Blit Swap Copy", out passData, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\FinalPostProcessPass.cs", 382))
			{
				rasterRenderGraphBuilder.UseTexture(in source);
				passData.sourceTexture = source;
