...
public class ColorGradingLutPass : ScriptableRenderPass
{
	...
	public override void RecordRenderGraph(ContextContainer frameData)
	{
		...
		PassData passData;
		using IRasterRenderGraphBuilder rasterRenderGraphBuilder = waaaghRenderingData.RenderGraph.AddRasterRenderPass<PassData>(Name, out passData, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\ColorGradingLutPass.cs", 252);
