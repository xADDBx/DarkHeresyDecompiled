...
public class BeforeTransparentPostProcessPass : ScriptableRenderPass
{
	...
	public override void RecordRenderGraph(ContextContainer frameData)
	{
		...
		renderGraph.BeginProfilingSampler(sampler, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\BeforeTransparentPostProcessPass.cs", 84);
		...
		RenderGraphBuilder renderGraphBuilder = renderGraph.AddRenderPass<PostProcessPassDataBase>("RenderBeforeTransparentPostProcess.FinalBlit", out passData2, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\BeforeTransparentPostProcessPass.cs", 117);
		try
		{
		...
		renderGraph.EndProfilingSampler(sampler, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\BeforeTransparentPostProcessPass.cs", 134);
	...
	private void RenderSSCS(RenderGraph renderGraph, WaaaghResourceData resources, TextureHandle source, TextureHandle destination)
	{
		...
		using RenderGraphBuilder renderGraphBuilder = renderGraph.AddRenderPass<SSCSPassData>("RenderBeforeTransparentPostProcess.SSCS", out passData2, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\BeforeTransparentPostProcessPass.cs", 158);
	...
	private void RenderMaskedColorTransform(RenderGraph renderGraph, WaaaghResourceData resources, TextureHandle source, TextureHandle destination)
	{
		...
		RenderGraphBuilder renderGraphBuilder = renderGraph.AddRenderPass<MaskedColorTransformPassData>("RenderBeforeTransparentPostProcess.MaskedColorTrasformPass", out passData2, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\PostProcess\\BeforeTransparentPostProcessPass.cs", 213);
		try
		{
