...
public class ShadowsDebugPass : ScriptableRenderPass<ShadowsDebugPassData>
{
	...
	protected override void Setup(RenderGraphBuilder builder, ShadowsDebugPassData data, ContextContainer frameData)
	{
		...
		data.ShadowsCacheEnabled = waaaghShadowData.StaticShadowsCacheEnabled;
