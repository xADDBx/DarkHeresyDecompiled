...
public class ScreenSpaceReflectionsPass : ScriptableRenderPass
{
	...
	public override void RecordRenderGraph(ContextContainer frameData)
	{
		...
		renderGraph.BeginProfilingSampler(sampler, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\ScreenSpaceReflectionsPass.cs", 209);
		...
		{
			renderGraph.EndProfilingSampler(sampler, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\ScreenSpaceReflectionsPass.cs", 276);
			return;
		}
		...
		using (RenderGraphBuilder renderGraphBuilder = renderGraph.AddRenderPass<RayTracingPassData>("Ray Trace", out passData2, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\ScreenSpaceReflectionsPass.cs", 284))
		{
		...
		using (RenderGraphBuilder renderGraphBuilder2 = renderGraph.AddRenderPass<ReprojectionPassData>("Reprojection", out passData3, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\ScreenSpaceReflectionsPass.cs", 326))
		{
		...
		if (value8)
		{
			...
			using (RenderGraphBuilder renderGraphBuilder3 = renderGraph.AddRenderPass<AccumulationPassData>("Accumulation", out passData4, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\ScreenSpaceReflectionsPass.cs", 359))
			{
			...
			if (value6)
			{
				...
				using RenderGraphBuilder renderGraphBuilder4 = renderGraph.AddRenderPass<BlurPassData>("Blur", out passData5, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\ScreenSpaceReflectionsPass.cs", 392);
		...
		else
		{
			...
			using (RenderGraphBuilder renderGraphBuilder5 = renderGraph.AddRenderPass<SsrPyramidPassData>("Ssr Pyramid", out passData6, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\ScreenSpaceReflectionsPass.cs", 421))
			{
			...
			using RenderGraphBuilder renderGraphBuilder6 = renderGraph.AddRenderPass<AccumulationPassData>("Accumulation", out passData7, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\ScreenSpaceReflectionsPass.cs", 457);
		...
		renderGraph.EndProfilingSampler(sampler, ".\\Library\\PackageCache\\com.owlcat.visual@01c4fcbc474f\\Runtime\\Waaagh\\Passes\\ScreenSpaceReflectionsPass.cs", 486);
	}
