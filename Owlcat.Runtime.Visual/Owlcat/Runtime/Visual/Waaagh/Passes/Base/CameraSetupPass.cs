...
public class CameraSetupPass : ScriptableRenderPass<CameraSetupPassData>
{
	...
	protected override void Setup(RenderGraphBuilder builder, CameraSetupPassData data, ContextContainer frameData)
	{
		...
		{
			PrepareCameraMatrices(data, waaaghCameraData, setInverseMatrices: true);
			return;
		}
		PrepareCameraMatrices(data, waaaghCameraData, setInverseMatrices: true);
		PrepareClippingPlanes(data, waaaghCameraData);
		PrepareBillboard(data, waaaghCameraData);
	}

	private void PrepareCameraMatrices(CameraSetupPassData data, WaaaghCameraData cameraData, bool setInverseMatrices)
	{
	...
	private void PrepareClippingPlanes(CameraSetupPassData data, WaaaghCameraData cameraData)
	{
	...
	private void PrepareBillboard(CameraSetupPassData data, WaaaghCameraData cameraData)
	{
