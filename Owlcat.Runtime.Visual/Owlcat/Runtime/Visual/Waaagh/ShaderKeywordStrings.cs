...
public static class ShaderKeywordStrings
{
	...
	public static readonly string TonemapMakeev = "_TONEMAP_MAKEEV";
	...
	public const string PROBE_VOLUMES_L1 = "PROBE_VOLUMES_L1";

	public const string PROBE_VOLUMES_L2 = "PROBE_VOLUMES_L2";

	public const string EVALUATE_SH_VERTEX = "EVALUATE_SH_VERTEX";

	public const string _LINEAR_TO_SRGB_CONVERSION = "_LINEAR_TO_SRGB_CONVERSION";

	internal const string _USE_FAST_SRGB_LINEAR_CONVERSION = "_USE_FAST_SRGB_LINEAR_CONVERSION";

	public const string _POINT_SAMPLING = "_POINT_SAMPLING";

	public const string _GAMMA_20_AND_HDR_INPUT = "_GAMMA_20_AND_HDR_INPUT";

	public const string _GAMMA_20 = "_GAMMA_20";

	public const string _EASU_RCAS_AND_HDR_INPUT = "_EASU_RCAS_AND_HDR_INPUT";

	public const string _RCAS = "_RCAS";
}
