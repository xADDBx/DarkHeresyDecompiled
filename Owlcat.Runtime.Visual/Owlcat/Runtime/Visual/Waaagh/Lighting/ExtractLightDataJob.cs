...
public struct ExtractLightDataJob : IJobFor
{
	...
	public void Execute(int index)
	{
		...
		uint x = PackData(lightDescriptor.LightFalloffType, lightDescriptor.SnapSpecularToInnerRadius, lightDescriptor.ShadowDataIndex, lightDescriptor.ShadowmaskChannel, lightDescriptor.LightLayerMask, lightDescriptor.VolumetricLighting, lightDescriptor.VolumetricShadows, lightDescriptor.LightCookieIndex, lightDescriptor.ColoredShadows);
	...
	private uint PackData(LightFalloffType lightFalloffType, bool snapSpecularToInnerRadius, int shadowDataIndex, int shadowmaskChannel, uint lightLayerMask, bool volumetricLighting, bool volumetricShadows, int lightCookieIndex, bool coloredShadows)
	{
		uint num = 0u;
		...
		return num | (coloredShadows ? 2147483648u : 0u);
	}
}
