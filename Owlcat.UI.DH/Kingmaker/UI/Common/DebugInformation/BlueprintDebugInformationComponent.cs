...
public class BlueprintDebugInformationComponent : MonoBehaviour, IDebugInformationUIHandler, ISubscriber
{
	...
	public void HandleShowDebugBubble()
	{
		...
		{
			BlueprintDebugInformationBubble component = UIConfig.Instance.DebugBubble.GetComponent<BlueprintDebugInformationBubble>();
			if (component != null)
			{
				m_InformationBubble = WidgetFactory.GetWidget(component, activate: true, strictMatching: true);
