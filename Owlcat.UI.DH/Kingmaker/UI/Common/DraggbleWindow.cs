...
public class DraggbleWindow : MonoBehaviour, IPointerDownHandler, IEventSystemHandler, IPointerUpHandler
{
	...
	public Action HandleOnPointerDown;

	public Action HandleOnPointerUp;
	...
	public void LateUpdate()
	{
		if (m_MoveMode)
		{
			...
			if (!(m_LastMausePos == vector))
			{
				...
				nPos = UIUtilityRect.LimitPositionRectInRect(nPos, m_ParentRectTransform, m_OwnRectTransform);
