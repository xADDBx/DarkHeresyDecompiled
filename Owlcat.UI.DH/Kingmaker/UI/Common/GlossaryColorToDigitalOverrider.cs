...
public class GlossaryColorToDigitalOverrider : MonoBehaviour
{
	...
	private GlossaryColors PaperColors => ConfigRoot.Instance.UIConfig.PaperGlossaryColors;

	private GlossaryColors DigitalColors => ConfigRoot.Instance.UIConfig.DigitalGlossaryColors;
