...
public class CombatLogVM : ViewModel, IUnitGetAbilityPush, ISubscriber
{
	...
	public readonly ObservableList<CombatLogBaseVM> Items = new ObservableList<CombatLogBaseVM>();
	...
	private readonly ReactiveProperty<bool> m_IsControlActive = new ReactiveProperty<bool>();

	private readonly ReactiveProperty<int> m_CurrentSizeIndex = new ReactiveProperty<int>(Game.Instance.Player.UISettings.CombatLogSizeIndex);

	private static LogThreadService LogThreadService => LogThreadService.Instance;

	public ReadOnlyReactiveProperty<CombatLogChannel> CurrentChannel => m_CurrentChannel;

	public ReadOnlyReactiveProperty<bool> IsActive => m_IsActive;

	public ReadOnlyReactiveProperty<bool> IsControlActive => m_IsControlActive;

	public ReadOnlyReactiveProperty<int> CurrentSizeIndex => m_CurrentSizeIndex;
	...
	protected override void OnDispose()
	{
		...
		m_Channels.Clear();
		Items.ForEach(delegate(CombatLogBaseVM i)
		{
			i.Dispose();
		});
	}
	...
	public void SetCurrentSizeIndex(int index)
	{
		m_CurrentSizeIndex.Value = index;
	}
