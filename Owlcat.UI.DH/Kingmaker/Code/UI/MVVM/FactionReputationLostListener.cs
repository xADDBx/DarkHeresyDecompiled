...
public class FactionReputationLostListener : NotificationListenerBase, IGainFactionReputationHandler, ISubscriber
{
	...
	public override DialogNotificationSoundType SoundType => DialogNotificationSoundType.ReceivedFactionReputation;

	public FactionReputationLostListener(DialogUIType dialogUIType)
		: base(dialogUIType)
	{
	}
