...
public class PartyConsoleView : View<PartyVM>, IGameModeHandler, ISubscriber, IFullScreenUIHandler, IFullScreenLocalMapUIHandler
{
	...
	{
		if (Game.Instance.CurrentModeType == GameModeType.Dialog || Game.Instance.CurrentModeType == GameModeType.Cutscene)
		{
