...
public class ServiceWindowsConsoleView : View<ServiceWindowsVM>
{
	[SerializeField]
	...
	private List<ServiceWindowsType> m_WindowsWithoutBgr = new List<ServiceWindowsType> { ServiceWindowsType.Inventory };
