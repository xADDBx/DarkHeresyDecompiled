...
public class TooltipBrickSlider : ITooltipBrick
{
	...
	public TooltipBrickSlider(int minValue, int maxValue, int value, List<BrickSliderValueVM> sliderValueVMs, bool showValue = false, int preferredHeight = 50, Color fillColor = default(Color), LocalizedString maxValueText = null)
	{
	...
	{
		return new TooltipBrickSliderVM(m_SliderValueVMs, m_MinValue, m_MaxValue, m_Value, m_ShowValue, m_PreferredHeight, m_FillColor, M_MaxValueText);
	}
}
