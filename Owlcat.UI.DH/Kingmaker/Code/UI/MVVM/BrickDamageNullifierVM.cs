...
public class BrickDamageNullifierVM : TooltipBrickVM
{
	...
	public BrickDamageNullifierVM(int chanceRoll, int resultRoll, int resultValue, string reasonText, IReadOnlyList<BuffInformation> reasonItems, string resultText)
	{
