...
public class KeyBindingSetupDialogBaseView : View<KeyBindingSetupDialogVM>
{
	[SerializeField]
	...
	[SerializeField]
	private OwlcatMultiButton m_UnbindButton;
	...
	public void Initialize()
	{
		...
		m_BindingIsOccupied.text = ConfigRoot.Instance.LocalizedTexts.UserInterfacesText.SettingsUI.HotkeyInUseErrorMessage;
	}
	...
	protected override void OnBind()
	{
		...
		m_UnbindButton.OnLeftClickAsObservable().Subscribe(base.ViewModel.Unbind).AddTo(this);
