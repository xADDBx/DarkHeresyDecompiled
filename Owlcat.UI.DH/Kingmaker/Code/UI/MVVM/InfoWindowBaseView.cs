...
public abstract class InfoWindowBaseView : InfoBaseView<InfoWindowVM>
{
	...
	protected override void OnBind()
	{
		...
		{
			ObservableSubscribeExtensions.Subscribe(m_ScrollRect.content.UpdateAsObservable(), delegate
			{
		...
		base.ViewModel.ForceClose.Subscribe(Close).AddTo(this);
	}
	...
	public void Hide()
	{
		...
		m_Animator.CanvasGroup.blocksRaycasts = false;
