...
public class NewGamePhaseStoryScenarioEntityVM : SelectionGroupEntityVM
{
	...
	private readonly ReactiveProperty<bool> m_IsStoryIsAvailable = new ReactiveProperty<bool>();
	...
	public ReadOnlyReactiveProperty<bool> IsStoryIsAvailable => m_IsStoryIsAvailable;
	...
	private void SetAvailableState()
	{
		...
		m_IsStoryIsAvailable.Value = value;
	}
