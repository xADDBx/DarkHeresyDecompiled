...
public class VendorBarterSlotPCView : InventorySlotView
{
	[Header("PC")]
	[SerializeField]
	...
	protected override void SetupContextMenu()
	{
		...
		List<ContextMenuCollectionEntity> contextMenu2 = new List<ContextMenuCollectionEntity>
		{
			...
			new ContextMenuCollectionEntity(contextMenu.Remove, OnDoubleClick, base.ViewModel.HasItem)
		};
	...
	{
		Game.Instance.GameCommandQueue.RemoveFromBuyVendor(base.ViewModel.ItemEntity, 1);
	}
