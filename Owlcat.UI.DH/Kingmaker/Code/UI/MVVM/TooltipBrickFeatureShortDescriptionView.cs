...
public class TooltipBrickFeatureShortDescriptionView : TooltipBaseBrickView<TooltipBrickFeatureDescriptionVM>
{
	...
	protected override void OnBind()
	{
		...
		m_Label.fontSize = (isControllerMouse ? m_DefaultFontSizeLabel : m_DefaultConsoleFontSizeLabel) * m_FontMultiplier;
		m_Description.fontSize = (isControllerMouse ? m_DefaultFontSizeDescription : m_DefaultConsoleFontSizeDescription) * m_FontMultiplier;
	}
}
