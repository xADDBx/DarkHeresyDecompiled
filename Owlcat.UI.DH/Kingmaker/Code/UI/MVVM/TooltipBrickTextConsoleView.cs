...
public class TooltipBrickTextConsoleView : TooltipBrickTextView, IConsoleTooltipBrick
{
	...
	protected override void OnBind()
	{
		...
		base.OnBind();
		m_FloatNavigationBehaviour = new FloatConsoleNavigationBehaviour(m_NavigationParameters).AddTo(this);
		m_GridNavigationBehaviour = new GridConsoleNavigationBehaviour().AddTo(this);
	}
