...
public class TooltipBrickDamageNullifier : ITooltipBrick
{
	...
	private readonly IReadOnlyList<BuffInformation> m_ReasonItems;

	private readonly string m_ResultText;

	public TooltipBrickDamageNullifier(int chanceRoll, int resultRoll, int resultValue, string reasonText, IReadOnlyList<BuffInformation> reasonItems, string resultText)
	{
