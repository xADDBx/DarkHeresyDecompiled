...
{
	private readonly Dictionary<int, Vector2> m_AbilityGridSpicing = new Dictionary<int, Vector2>
	{
		{
			0,
			new Vector2(0f, 0f)
	...
	private const string FilterButtonOn = "On";

	private const string FilterButtonOff = "Off";
	...
	private void DrawAbilities(List<AbilitySlotVM> list)
	{
		...
		Vector2 spacing = m_AbilityGridSpicing[num];
