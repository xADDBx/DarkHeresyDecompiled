...
public class DlcManagerSwitchOnDlcEntityBaseView : SelectionGroupEntityView<DlcManagerSwitchOnDlcEntityVM>, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler
{
	[Header("Info")]
	[SerializeField]
