...
public class TooltipBrickLevelUpFittingAbilitiesVM : TooltipBaseBrickVM
{
	...
	public TooltipBrickLevelUpFittingAbilitiesVM(BlueprintAbilityModifier blueprintModifier, BaseUnitEntity unit)
	{
	...
	private void Init()
	{
		m_Abilities.AddRange((from ability in m_Unit.Abilities.Visible
			where !ability.Blueprint.IsWeaponAbility && m_PartAbilityModifiers.IsSuitableModifier(m_BlueprintModifier, ability)
