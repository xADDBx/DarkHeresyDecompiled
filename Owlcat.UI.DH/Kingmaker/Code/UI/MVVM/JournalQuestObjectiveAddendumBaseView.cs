...
public class JournalQuestObjectiveAddendumBaseView : View<JournalQuestObjectiveAddendumVM>
{
	[Header("Description")]
	[SerializeField]
	[UsedImplicitly]
	...
	protected virtual void SetupDescription()
	{
		...
		base.ViewModel.UpdateStatus.Subscribe(SetupState).AddTo(this);
	}
	...
	protected virtual void SetupState()
	{
		...
		m_UpdatedMark.gameObject.SetActive(!base.ViewModel.IsViewed && !base.ViewModel.IsFailed && !base.ViewModel.IsCompleted);
