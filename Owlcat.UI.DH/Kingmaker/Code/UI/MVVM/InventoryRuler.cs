...
public class InventoryRuler : MonoBehaviour, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler
{
	...
	private static readonly int CentralElementProperty = Shader.PropertyToID("_CentralElement");
	...
	[SerializeField]
	private bool m_CentralElement = true;
	...
	private void Awake()
	{
		...
		Material.SetFloat(VerticalProperty, m_Vertical ? 1f : 0f);
		Material.SetFloat(CentralElementProperty, m_CentralElement ? 1f : 0f);
		m_Image.SetMaterialDirty();
	}
}
