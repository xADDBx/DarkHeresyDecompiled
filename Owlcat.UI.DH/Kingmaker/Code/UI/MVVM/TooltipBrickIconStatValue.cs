...
public class TooltipBrickIconStatValue : ITooltipBrick
{
	...
	{
		return new TooltipBrickIconStatValueVM(m_Name, m_Value, m_AddValue, m_Icon, m_IconColor, m_IconSize, m_IconText, m_Type, m_BackgroundType, m_ValueHint, m_HasValue, m_Tooltip, m_ReactiveValue, m_ReactiveAddValue);
	}
}
