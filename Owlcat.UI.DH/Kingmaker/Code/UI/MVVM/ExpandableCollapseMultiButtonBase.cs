...
public class ExpandableCollapseMultiButtonBase : MonoBehaviour, IConsoleNavigationEntity, IConsoleEntity, IConfirmClickHandler
{
	...
	public ReadOnlyReactiveProperty<bool> IsOn => m_IsOnProperty;
	...
	{
		m_DisposableButton = ObservableSubscribeExtensions.Subscribe(m_MultiButton.OnLeftClickAsObservable(), delegate
		{
			OnMultiButtonClick();
		});
	}
