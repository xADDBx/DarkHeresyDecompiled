...
public class TooltipBrickSliderVM : TooltipBaseBrickVM
{
	...
	public TooltipBrickSliderVM(List<BrickSliderValueVM> sliderValueVMs, int minValue, int maxValue, int value, bool showValue, int preferredHeight = 50, Color fillColor = default(Color), LocalizedString maxValueText = null)
	{
