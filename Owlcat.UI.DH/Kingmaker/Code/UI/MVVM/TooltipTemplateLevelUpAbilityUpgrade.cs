...
public class TooltipTemplateLevelUpAbilityUpgrade : TooltipBaseTemplate
{
	...
	{
		yield return new BrickLevelUpHeaderVM(new LevelUpFeatureUIData(new TextValueElement(m_UpgradeAbility.Name), null, null, null, m_UpgradeAbility.Icon.GetDefaultIfNull(DefaultImageType.Ability)));
	}
	...
	public override IEnumerable<ITooltipBrick> GetBody(TooltipTemplateType type)
	{
		...
		{
			new BrickLevelUpAbilityUpgradeDescriptionVM(GetDescription(m_UpgradeAbility), GetDescription(m_BaseAbility))
		};
	}
	...
	private string GetDescription(IUIDataProvider ability)
	{
		using (GameLogContext.Scope)
		{
			...
			return ability?.Description ?? string.Empty;
		}
	}
}
