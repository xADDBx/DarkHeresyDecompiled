...
public class ActionBarSlotConsumableConsoleView : ActionBarSlotConsumableView, IConsoleNavigationEntity, IConsoleEntity, IConfirmClickHandler, IHasTooltipTemplate
{
	[Header("ConsoleSlot")]
	[SerializeField]
