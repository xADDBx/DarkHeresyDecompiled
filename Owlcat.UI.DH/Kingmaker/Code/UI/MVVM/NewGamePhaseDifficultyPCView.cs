...
public class NewGamePhaseDifficultyPCView : NewGamePhaseDifficultyBaseView
{
	...
	protected override void OnBind()
	{
		...
		{
			base.ViewModel.IsEnabled.CombineLatest(base.ViewModel.IsDefaultButtonInteractable, (bool isEnabled, bool defaultButtonInteractable) => new { isEnabled, defaultButtonInteractable }).Subscribe(value =>
			{
			...
			ObservableSubscribeExtensions.Subscribe(m_DefaultDifficultyButton.OnLeftClickAsObservable(), delegate
			{
