...
public class CareerPathProgressionCommonView : View<CareerPathVM>
{
	[Space]
	[SerializeField]
	...
	protected override void OnBind()
	{
		...
		base.ViewModel.IsDescriptionShowed.Skip(1).Subscribe(AnimateSwitchDescription).AddTo(this);
		DelayedInvoker.InvokeInFrames(delegate
		{
			AnimateSwitchDescription(base.ViewModel?.IsDescriptionShowed.CurrentValue ?? false);
		}, 1);
