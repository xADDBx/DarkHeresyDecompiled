...
public class RankEntryFeatureItemCommonView : VirtualListElementViewBase<BaseRankEntryFeatureVM>, IFloatConsoleNavigationEntity, IConsoleNavigationEntity, IConsoleEntity, IConfirmClickHandler, IFuncAdditionalClickHandler, IHasNeighbours, IRankEntryElement
{
	[SerializeField]
	...
	private void DoClick()
	{
		...
		bool flag = currentValue != RankFeatureState.NotActive && currentValue != RankFeatureState.NotValid;
	...
	public void OnConfirmClick()
	{
		...
		if (base.ViewModel.FeatureState.CurrentValue != RankFeatureState.Selected || (!m_IsListEntry && unitProgressionVM.CurrentRankEntryItem.CurrentValue != base.ViewModel) || unitProgressionVM is UnitProgressionVM { IsCharGen: not false })
		{
	...
	{
		m_FavoritesToggle.Set(!m_FavoritesToggle.IsOn.CurrentValue);
	}
