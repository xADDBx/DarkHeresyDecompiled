...
public class CharInfoAlignmentShiftRecordPCView : View<CharInfoAlignmentShiftRecordVM>
{
	[SerializeField]
	...
	{
		return "<color=#" + ColorUtility.ToHtmlStringRGBA(GetDirectionColor()) + ">" + $"+{base.ViewModel.Amount} {UIUtilityAlignment.GetAlignmentDirectionText(base.ViewModel.Axis).Text}</color>";
	}
