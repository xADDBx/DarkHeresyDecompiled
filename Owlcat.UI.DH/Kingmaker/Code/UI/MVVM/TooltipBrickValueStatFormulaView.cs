...
public class TooltipBrickValueStatFormulaView : TooltipBaseBrickView<TooltipBrickValueStatFormulaVM>
{
	...
	protected override void OnBind()
	{
		...
		m_Value.fontSize = (isControllerMouse ? m_DefaultFontSize : m_DefaultConsoleFontSize) * m_FontMultiplier;
		m_Symbol.fontSize = (isControllerMouse ? m_DefaultFontSize : m_DefaultConsoleFontSize) * m_FontMultiplier;
		m_Title.fontSize = (isControllerMouse ? m_DefaultFontSize : m_DefaultConsoleFontSize) * m_FontMultiplier;
	}
}
