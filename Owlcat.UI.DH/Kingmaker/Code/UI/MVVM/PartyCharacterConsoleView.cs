...
public class PartyCharacterConsoleView : View<PartyCharacterVM>, IScrollHandler, IEventSystemHandler, IBeginDragHandler, IEndDragHandler, IDragHandler
{
	[Header("Parts Block")]
	[SerializeField]
	...
	[SerializeField]
	private UnitBuffBlockPCView m_BuffView;
	...
	protected override void OnBind()
	{
		...
		base.ViewModel.IsLevelUp.Subscribe(m_LevelUpButton.gameObject.SetActive).AddTo(this);
		base.ViewModel.IsSingleSelected.Subscribe(SetSelected).AddTo(this);
		base.ViewModel.IsLinked.Subscribe(delegate(bool value)
		{
