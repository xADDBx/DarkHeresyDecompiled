...
public class TooltipBrickArmourHeaderView : View<TooltipBrickArmourHeaderVM>
{
	[Header("Title")]
	[SerializeField]
	...
	protected override void OnBind()
	{
		...
		m_TagsWidgetList.DrawEntries(base.ViewModel.TagSettings.Select((ArmourTagUISettings t) => new ArmourTagData(t)), m_TagPrefab).AddTo(this);
