...
public static class UIConsts
{
	...
	public static int MinLootSlotsInSingleObj = 30;

	public static int MinLootSlotsInShort = 12;

	public static int MinLootSlotsInZoneExit = 30;

	public static int ItemsToShowLootNotificationWindow = 5;
	...
	public static int MinLootSlotsInRowZoneExit = 5;
