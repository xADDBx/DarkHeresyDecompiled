...
public class HashSetSerializer<TConcreteHashSet, TElement> : AObjectSerializer<TConcreteHashSet> where TConcreteHashSet : HashSet<TElement>, new()
{
	public static TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		Name = typeof(TConcreteHashSet).FullName,
		Fields = null,
	...
	protected override void SerializeInternal<TFormatter>(TFormatter formatter, ref TConcreteHashSet? value, SerializerState state)
	{
		if (value == null)
		{
		...
		ushort type = state.TypeLibrary.RegisterType<TConcreteHashSet>(OwlPackTypeInfo);
	...
	protected override void DeserializeInternal<TFormatter>(TFormatter formatter, ref TConcreteHashSet? value, uint objectId, DeserializerState state)
	{
		InputFormatter.CreateElementDelegate(formatter, ref m_ElementDeserializer);
		value = new TConcreteHashSet();
