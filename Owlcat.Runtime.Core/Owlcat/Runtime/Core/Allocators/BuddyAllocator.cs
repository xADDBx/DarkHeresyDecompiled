...
public struct BuddyAllocator : IDisposable
{
	...
	private readonly (int, int) m_ActiveFreeMaskCounts;

	private readonly (int, int) m_FreeMasksStorage;

	private readonly (int, int) m_FreeMaskIndicesStorage;
