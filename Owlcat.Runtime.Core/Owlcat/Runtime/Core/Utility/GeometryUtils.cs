...
public static class GeometryUtils
{
	...
	{
		if (Physics.Linecast(new Vector3(p.x, 5000f, p.z), new Vector3(p.x, -5000f, p.z), out var hitInfo, 2359553))
		{
	...
	public static int GetCustomCellDistance(Vector3 a, Vector3 b, float gridCellSize)
	{
