...
internal class VirtualListViewsFabric
{
	...
	private static List<VirtualListViewsFabric> s_Instances;
	...
	static VirtualListViewsFabric()
	{
		s_Instances = new List<VirtualListViewsFabric>();
		WidgetFactoryStash.RegisterDestroyAll(DestroyAll);
	}
