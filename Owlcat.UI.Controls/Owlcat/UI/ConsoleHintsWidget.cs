...
public class ConsoleHintsWidget : MonoBehaviour, IDisposable
{
	...
	public IConsoleHint CreateCustomHint(List<int> actionIds, InputLayer inputLayer, string label = "", ReadOnlyReactiveProperty<bool> hintIsActive = null, HintPosition hintPosition = HintPosition.Center)
	{
	...
	public IConsoleHint CreateCustomHint(int actionId, InputLayer inputLayer, string label = "", ReadOnlyReactiveProperty<bool> hintIsActive = null, HintPosition hintPosition = HintPosition.Center)
	{
