...
public class CustomConsoleHintDescription : ConsoleHintDescription
{
	...
	protected readonly ReadOnlyReactiveProperty<bool> m_HintIsActive;

	public CustomConsoleHintDescription(Transform holderTransform, ConsoleHint hintPrefab, HintsLabelPlacement labelPlacement, List<int> actionIds, InputLayer inputLayer, string label, ReadOnlyReactiveProperty<bool> hintIsActive)
