...
public class OwlcatMultiButton : OwlcatMultiSelectable, IConfirmClickHandler, IConsoleEntity, ILongConfirmClickHandler, IDeclineClickHandler, ILongDeclineClickHandler, IFunc01ClickHandler, ILongFunc01ClickHandler, IFunc02ClickHandler, ILongFunc02ClickHandler, IPointerClickHandler, IEventSystemHandler, IConsolePointerLeftClickEvent, IConsoleNavigationEntity
{
	...
	[SerializeField]
	private Button.ButtonClickedEvent m_OnSingleLeftClick = new Button.ButtonClickedEvent();

	[SerializeField]
	private Button.ButtonClickedEvent m_OnSingleRightClick = new Button.ButtonClickedEvent();

	[SerializeField]
	private Button.ButtonClickedEvent m_OnLeftDoubleClick = new Button.ButtonClickedEvent();

	[SerializeField]
	private Button.ButtonClickedEvent m_OnRightDoubleClick = new Button.ButtonClickedEvent();

	[SerializeField]
	private Button.ButtonClickedEvent m_OnLeftClickNotInteractable = new Button.ButtonClickedEvent();

	[SerializeField]
	private Button.ButtonClickedEvent m_OnRightClickNotInteractable = new Button.ButtonClickedEvent();

	[SerializeField]
	private Button.ButtonClickedEvent m_OnSingleLeftClickNotInteractable = new Button.ButtonClickedEvent();

	[SerializeField]
	private Button.ButtonClickedEvent m_OnSingleRightClickNotInteractable = new Button.ButtonClickedEvent();

	[SerializeField]
	private Button.ButtonClickedEvent m_OnLeftDoubleClickNotInteractable = new Button.ButtonClickedEvent();

	[SerializeField]
	private Button.ButtonClickedEvent m_OnRightDoubleClickNotInteractable = new Button.ButtonClickedEvent();
	...
	public Button.ButtonClickedEvent OnLeftClick => m_OnLeftClick;

	public Button.ButtonClickedEvent OnRightClick => m_OnRightClick;

	public Button.ButtonClickedEvent OnSingleLeftClick => m_OnSingleLeftClick;

	public Button.ButtonClickedEvent OnSingleRightClick => m_OnSingleRightClick;

	public Button.ButtonClickedEvent OnLeftDoubleClick => m_OnLeftDoubleClick;

	public Button.ButtonClickedEvent OnRightDoubleClick => m_OnRightDoubleClick;

	public Button.ButtonClickedEvent OnLeftClickNotInteractable => m_OnLeftClickNotInteractable;

	public Button.ButtonClickedEvent OnRightClickNotInteractable => m_OnRightClickNotInteractable;

	public Button.ButtonClickedEvent OnSingleLeftClickNotInteractable => m_OnSingleLeftClickNotInteractable;

	public Button.ButtonClickedEvent OnSingleRightClickNotInteractable => m_OnSingleRightClickNotInteractable;

	public Button.ButtonClickedEvent OnLeftDoubleClickNotInteractable => m_OnLeftDoubleClickNotInteractable;

	public Button.ButtonClickedEvent OnRightDoubleClickNotInteractable => m_OnRightDoubleClickNotInteractable;
