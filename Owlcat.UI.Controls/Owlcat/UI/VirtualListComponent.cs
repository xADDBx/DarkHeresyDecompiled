...
public abstract class VirtualListComponent : MonoBehaviour
{
	...
	public ReactiveCommand<Unit> AttachedFirstValidView => m_VirtualList?.AttachedFirstValidView;
	...
	public IDisposable Subscribe<TData>(ObservableList<TData> datas) where TData : IVirtualListElementData
	{
		...
		compositeDisposable.Add(ObservableSubscribeExtensions.Subscribe(datas.ObserveReset(), delegate
		{
			m_VirtualList.Clear();
		}));
	...
	public IConsoleEntity TryGetNavigationEntity<TData>(TData viewModel)
	{
