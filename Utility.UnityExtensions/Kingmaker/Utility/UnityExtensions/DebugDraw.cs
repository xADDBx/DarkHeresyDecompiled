...
public static class DebugDraw
{
	...
	{
		DrawCircle(center, Vector3.forward, radius, color, DepthTestType.Alpha);
		DrawCircle(center, Vector3.up, radius, color, DepthTestType.Alpha);
		DrawCircle(center, Vector3.right, radius, color, DepthTestType.Alpha);
	}
}
