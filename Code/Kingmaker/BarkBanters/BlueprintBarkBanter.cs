...
public class BlueprintBarkBanter : BlueprintScriptableObject, IWeighted
{
	...
	public IEnumerable<BlueprintUnit> AllSpeakers()
	{
		yield return Unit;
		BanterResponseEntry[] responses = Responses;
		foreach (BanterResponseEntry banterResponseEntry in responses)
		{
			yield return banterResponseEntry.Unit;
		}
	}
