...
public class UnitAnimationActionJump : UnitAnimationAction
{
	...
	public class JumpVariantSettings
	{
		...
		[AssetPicker("")]
		[SerializeField]
		private AnimationClipWrapper m_JumpOutLeftHand;
	...
	private static float CrossfadeTime => Game.Instance.Controllers.TimeController.DeltaTime;
	...
	public override void OnStart(UnitAnimationActionHandle handle)
	{
		...
		PFLog.Animations.Log($"Crossfade = {CrossfadeTime}");
	...
	{
		AnimationClipWrapper animationClipWrapper = WeaponStyleSettings.FirstOrDefault((JumpVariantSettings i) => i.Style == handle.WeaponStyle)?.GetAnimation(state, handle);
