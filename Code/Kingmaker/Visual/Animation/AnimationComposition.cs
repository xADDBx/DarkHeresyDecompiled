...
{
	private readonly List<AnimationBase> m_PlayableInfos = new List<AnimationBase>();
	...
	public void AddPlayableInfo(AnimationBase playableInfo)
	{
	...
	public override void InitOrIncrementTime(float deltaTime)
	{
		base.InitOrIncrementTime(deltaTime);
		for (int i = 0; i < m_PlayableInfos.Count; i++)
		{
			m_PlayableInfos[i].InitOrIncrementTime(deltaTime);
		}
	}
}
