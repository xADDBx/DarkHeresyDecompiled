...
public static class FamiliarHelper
{
	...
	public static AbstractUnitEntity SpawnFamiliar(BaseUnitEntity leader, BlueprintUnit unit, bool spawnBaseUnit = false)
	{
		...
		{
			abstractUnitEntity = ((!spawnBaseUnit) ? Game.Instance.Controllers.EntitySpawner.SpawnLightweightUnit(unit, bundledResourceHandle.Object, leader.Position, Quaternion.identity, leader.HoldingState) : Game.Instance.Controllers.EntitySpawner.SpawnUnit(unit, bundledResourceHandle.Object, leader.Position, Quaternion.identity, leader.HoldingState));
		}
	...
	public static void DeSpawnFamiliar(BaseUnitEntity leader, AbstractUnitEntity familiar, bool immediately)
	{
		...
		Game.Instance.Controllers.EntityDestroyer.Destroy(familiar);
	}
}
