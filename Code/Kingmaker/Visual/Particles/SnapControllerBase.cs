...
public abstract class SnapControllerBase : MonoBehaviour
{
	...
	{
		BoneCollector boneCollector = new BoneCollector(snapMap, LocatorGroups, SnapType == ParticleSnapType.Transforms && !m_IsRotatableCopy, SnapType == ParticleSnapType.Transforms && m_IsRotatableCopy, Offset.WorldRotationBone);
