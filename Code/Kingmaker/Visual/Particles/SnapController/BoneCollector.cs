...
internal readonly struct BoneCollector
{
	...
	public BoneCollector([NotNull] SnapMapBase snapMap, ReferenceArrayProxy<BlueprintFxLocatorGroup> locatorGroups, bool ignoreRotatableBones, bool ignoreNonRotatableBones, string rotationRootBoneName, bool useRandomBonesAmount = false, float randomPercent = 1f)
	{
		if (snapMap == null)
		{
