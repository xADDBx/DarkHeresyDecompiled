...
public class SnapToLocator : MonoBehaviour
{
	...
	public void Attach(SnapMapBase map)
	{
		if (map != null)
		{
			m_Locator = null;
	...
	private void LateUpdate()
	{
		...
		if (!DontMove)
		{
			...
			float num = CameraOffsetScale.Evaluate(m_LocalTime += Game.Instance.Controllers.TimeController.DeltaTime);
