...
public class UnitAsksService : IService, IDisposable
{
	...
	private UnitAsksService()
	{
		...
		Register(new ChannelingAsksController());
		Register(new MoraleAsksController());
		Register(new PowerBalanceAsksController());
		Register(new DetectiveStudyAvailableAsksController());
		Register(new DetectiveConclusionAvailableAsksController());
