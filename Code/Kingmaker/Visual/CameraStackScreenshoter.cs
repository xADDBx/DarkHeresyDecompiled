...
public static class CameraStackScreenshoter
{
	...
	private static GraphicsFormat MakeRenderTextureGraphicsFormat(Camera camera)
	{
		...
		if (num)
		{
			if (!flag && hDRColorBufferPrecision != HDRColorBufferPrecision._64Bits && RenderingUtils.SupportsGraphicsFormat(GraphicsFormat.B10G11R11_UFloatPack32, GraphicsFormatUsage.Linear | GraphicsFormatUsage.Render))
			{
