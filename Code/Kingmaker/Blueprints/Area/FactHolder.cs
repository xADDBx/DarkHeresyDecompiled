...
public class FactHolder : MonoBehaviour
{
	...
	public class Fact : MechanicEntityFact, IHashable, IOwlPackable<Fact>
	{
		...
		{
			Fact source = new Fact();
			result = Unsafe.As<Fact, TPossiblyBase>(ref source);
		}
		...
		public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
		{
			...
			ushort type = state.TypeLibrary.RegisterType<Fact>(OwlPackTypeInfo);
		...
		public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
		{
			...
			TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<Fact>();
