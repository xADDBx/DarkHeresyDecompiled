...
public class BlueprintAreaEnterPointReference : BlueprintReference<BlueprintAreaEnterPoint>, IMemoryPackable<BlueprintAreaEnterPointReference>, IMemoryPackFormatterRegister
{
	...
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref BlueprintAreaEnterPointReference value)
		{
			BlueprintAreaEnterPointReference.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref BlueprintAreaEnterPointReference value)
		{
			BlueprintAreaEnterPointReference.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref BlueprintAreaEnterPointReference value)
		{
			BlueprintAreaEnterPointReference.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref BlueprintAreaEnterPointReference? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref BlueprintAreaEnterPointReference? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref BlueprintAreaEnterPointReference? value)
	{
