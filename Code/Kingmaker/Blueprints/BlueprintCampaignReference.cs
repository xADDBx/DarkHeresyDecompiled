...
public class BlueprintCampaignReference : BlueprintReference<BlueprintCampaign>, IMemoryPackable<BlueprintCampaignReference>, IMemoryPackFormatterRegister
{
	...
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref BlueprintCampaignReference value)
		{
			BlueprintCampaignReference.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref BlueprintCampaignReference value)
		{
			BlueprintCampaignReference.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref BlueprintCampaignReference value)
		{
			BlueprintCampaignReference.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref BlueprintCampaignReference? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref BlueprintCampaignReference? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref BlueprintCampaignReference? value)
	{
