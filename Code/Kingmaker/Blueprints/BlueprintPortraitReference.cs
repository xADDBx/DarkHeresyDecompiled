...
public class BlueprintPortraitReference : BlueprintReference<BlueprintPortrait>, IMemoryPackable<BlueprintPortraitReference>, IMemoryPackFormatterRegister
{
	...
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref BlueprintPortraitReference value)
		{
			BlueprintPortraitReference.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref BlueprintPortraitReference value)
		{
			BlueprintPortraitReference.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref BlueprintPortraitReference value)
		{
			BlueprintPortraitReference.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref BlueprintPortraitReference? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref BlueprintPortraitReference? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref BlueprintPortraitReference? value)
	{
