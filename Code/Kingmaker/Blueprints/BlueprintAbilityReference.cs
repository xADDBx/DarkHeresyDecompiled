...
public class BlueprintAbilityReference : BlueprintReference<BlueprintAbility>, IMemoryPackable<BlueprintAbilityReference>, IMemoryPackFormatterRegister
{
	...
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref BlueprintAbilityReference value)
		{
			BlueprintAbilityReference.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref BlueprintAbilityReference value)
		{
			BlueprintAbilityReference.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref BlueprintAbilityReference value)
		{
			BlueprintAbilityReference.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref BlueprintAbilityReference? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref BlueprintAbilityReference? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref BlueprintAbilityReference? value)
	{
