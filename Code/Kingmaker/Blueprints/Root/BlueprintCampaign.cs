	...
	public IEnumerable<BlueprintDlc> AdditionalContentDlc
	{
		get
		{
			if (m_AdditionalContentDlc == null)
			{
				...
				foreach (IBlueprintDlc dlc in ConfigRoot.Instance.DlcSettings.Dlcs)
				{
