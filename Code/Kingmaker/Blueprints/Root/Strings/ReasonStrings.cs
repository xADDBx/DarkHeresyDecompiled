...
public class ReasonStrings : StringsContainer
{
	...
	public LocalizedString NotEnoughStat;

	public LocalizedString CantUseNeed;

	public LocalizedString CantUseRemove;

	public LocalizedString MoraleShouldBe;
	...
	public LocalizedString TargetArmorCondition;
	...
	public LocalizedString CannotTargetBodyPartByPreciseAttack;
	...
	public static ReasonStrings Instance => ConfigRoot.Instance.LocalizedTexts.Reasons;
