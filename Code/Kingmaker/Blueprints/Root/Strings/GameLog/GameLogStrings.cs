...
public class GameLogStrings : StringsContainer
{
	...
	[Header("ColorText")]
	public ColorTextString MoraleColorText;
	...
	public ColorTextString VitalDamageColorText;
	...
	[FormerlySerializedAs("WarhammerSourceDealCriticalDamage")]
	public GameLogMessage WarhammerSourceDealVitalDamage;
	...
	public GameLogMessage WarhammerDefended;
	...
	public GameLogMessage QuickSlotsReplenishSuccess;

	public GameLogMessage QuickSlotsReplenishFailure;

	public GameLogMessage QuickSlotReplenishItem;
	...
	public GameLogMessage CriticalEffectStageChanged;

	public GameLogMessage BodyPartHitBreakConcentration;

	public GameLogMessage BodyPartHitChangeTurn;

	public GameLogMessage DispersedDamage;

	public GameLogMessage DispersedDamageGroup;
	...
	[Header("Morale")]
	public GameLogMessage MoraleValueChangedMultipleUnits;

	public GameLogMessage MoraleValueChangedSingleUnit;

	public GameLogMessage MoraleValueAndPhaseChangedSingleUnit;
	...
	public static GameLogStrings Instance => ConfigRoot.Instance.LocalizedTexts.GameLog;
}
