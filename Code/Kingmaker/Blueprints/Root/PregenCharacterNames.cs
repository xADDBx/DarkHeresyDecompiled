...
[ComponentName("Root/PregenCharacterNames")]
...
public class PregenCharacterNames : ScriptableObject
{
	...
	private List<string> GetNamesList(Race race, Gender gender, CharGenMode mode, string exceptName)
	{
	...
	public string GetRandomName(Race race, Gender gender, CharGenMode mode, string exceptName)
	{
		return GetNamesList(race, gender, mode, exceptName).Random(PFStatefulRandom.NonDeterministic);
	}

	public string GetDefaultName(Race race, Gender gender, CharGenMode mode, string exceptName)
	{
	...
	public string ReplaceCharacterNameIfCustom(Race race, Gender gender, CharGenMode mode, string characterName)
	{
