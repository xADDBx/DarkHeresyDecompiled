...
[ComponentName("Root/CalendarRoot")]
public class CalendarRoot : StringsContainer
{
	...
	{
		return GetDateText(Game.Instance.Controllers.TimeController.GameTime, formatType);
	}

	public string GetCurrentDayOfWeak()
	{
		return GetDateText(Game.Instance.Controllers.TimeController.GameTime, GameDateFormat.DayOfWeek);
	}
	...
	public string GetMonthText(int month, bool monthWithRomanNumber = false)
	{
		...
		{
			return $"{localizedString} ({UtilityText.ArabicToRoman(month)})";
		}
