...
public class BlueprintEtude : BlueprintFact, IEtudeReference, IUIDataProvider
{
	...
	[SerializeField]
	private List<BlueprintCampaignReference> m_LinkedCampaigns = new List<BlueprintCampaignReference>();
	...
	[SerializeField]
	[ShowCreator]
	private List<BlueprintAreaMechanicsReference> m_AddedAreaMechanics = new List<BlueprintAreaMechanicsReference>();
	...
	string IUIDataProvider.Name => string.Empty;
