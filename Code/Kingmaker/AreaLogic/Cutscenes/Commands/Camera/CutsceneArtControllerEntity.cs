...
public class CutsceneArtControllerEntity : SimpleEntity, IHashable, IOwlPackable<CutsceneArtControllerEntity>
{
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		Name = "CutsceneArtControllerEntity",
		OldNames = null,
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<CutsceneArtControllerEntity>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<CutsceneArtControllerEntity>();
