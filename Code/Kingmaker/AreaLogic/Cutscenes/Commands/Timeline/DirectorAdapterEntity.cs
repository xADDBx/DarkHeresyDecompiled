...
public sealed class DirectorAdapterEntity : SimpleEntity, IHashable, IOwlPackable<DirectorAdapterEntity>
{
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<DirectorAdapterEntity>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<DirectorAdapterEntity>();
