...
public class CutsceneAnchorEntity : SimpleEntity, IHashable, IOwlPackable<CutsceneAnchorEntity>
{
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		Name = "CutsceneAnchorEntity",
		OldNames = null,
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<CutsceneAnchorEntity>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<CutsceneAnchorEntity>();
