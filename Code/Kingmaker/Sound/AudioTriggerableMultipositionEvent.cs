...
internal class AudioTriggerableMultipositionEvent : AudioTriggerableEvent
{
	...
	public override void OnTrigger()
	{
		if (!m_PositionsUpdated)
		{
			...
			AkUnitySoundEngine.SetMultiplePositions(base.gameObject, akPositionArray, (ushort)akPositionArray.Count, AkMultiPositionType.MultiPositionType_MultiSources);
