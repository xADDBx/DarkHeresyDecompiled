...
public class AudioZone : RegisteredBehaviour
{
	...
	private Coroutine m_DelayedSetCoroutine;
	...
	public void ExclusiveDelayedAction(float delay, Action action)
	{
		if (m_DelayedSetCoroutine != null)
		{
			StopCoroutine(m_DelayedSetCoroutine);
		}
		m_DelayedSetCoroutine = StartCoroutine(DelayedAction(delay, action));
	}

	private IEnumerator DelayedAction(float delay, Action action)
	{
		yield return new WaitForSeconds(delay);
		m_DelayedSetCoroutine = null;
		action();
	}
