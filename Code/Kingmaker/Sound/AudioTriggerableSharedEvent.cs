	...
	private class SharedEventData
	{
		...
		public void DoTrigger(AkEventReference evt)
		{
			...
			if (!PositionsUpdated)
			{
				...
				AkUnitySoundEngine.SetMultiplePositions(List[0].gameObject, akPositionArray, (ushort)akPositionArray.Count, AkMultiPositionType.MultiPositionType_MultiSources);
