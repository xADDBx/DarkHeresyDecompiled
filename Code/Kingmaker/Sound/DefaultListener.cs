...
public class DefaultListener : RegisteredBehaviour, IRegistrationCallback
{
	...
	{
		AkUnitySoundEngine.SetDefaultListeners(new ulong[1] { AkUnitySoundEngine.GetAkGameObjectID(base.gameObject) }, 1u);
	}

	public void OnBeforeUnregister()
	{
		AkUnitySoundEngine.RemoveDefaultListener(base.gameObject);
