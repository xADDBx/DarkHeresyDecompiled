...
public static class PartyAutoFormationHelper
{
	...
	private static float SpaceX => ConfigRoot.Instance.Formations.AutoFormation.SpaceX;

	private static float SpaceY => ConfigRoot.Instance.Formations.AutoFormation.SpaceY;
