...
public class EvaluatedUnitTurnTrigger : EntityFactComponentDelegate, ITurnStartHandler, ISubscriber<IMechanicEntity>, ISubscriber, ITurnEndHandler
{
	...
	public class Data : IEntityFactComponentSavableData, IHashable, IOwlPackable<Data>
	{
		...
		public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
		{
			...
			{
				new FieldInfo("CurrentTurn", typeof(int)),
				new FieldInfo("IsOneActivated", typeof(bool))
			}
		};
		...
		public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
		{
			...
			formatter.UnmanagedField(0, "CurrentTurn", ref CurrentTurn, state);
			formatter.UnmanagedField(1, "IsOneActivated", ref IsOneActivated, state);
			formatter.EndObject();
		}
		...
		public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
		{
			...
			for (int i = 0; i < typeInfo.Fields.Length; i++)
			{
				...
				case byte.MaxValue:
					...
					break;
				case 0:
					CurrentTurn = formatter.ReadUnmanaged<int>(state);
					break;
				case 1:
					IsOneActivated = formatter.ReadUnmanaged<bool>(state);
					break;
				}
			}
