...
public class BuffSubstitutionOnApply : UnitFactComponentDelegate, IInitiatorRulebookHandler<RuleCalculateCanApplyBuff>, IRulebookHandler<RuleCalculateCanApplyBuff>, ISubscriber, IInitiatorRulebookSubscriber
{
	[SerializeField]
	...
	public void OnEventAboutToTrigger(RuleCalculateCanApplyBuff evt)
	{
		...
		{
			evt.CanApply = false;
			base.Owner.Buffs.Add(SubstituteBuff, evt.ConcreteInitiator, null, evt.Duration);
		}
	}
