...
public class PartyUnits : GameAction
{
	...
	public override string GetCaption()
	{
		return m_UnitsList switch
		{
			...
			Player.CharactersList.PartyExceptMainCharacter => "Party (not pets) except main character", 
