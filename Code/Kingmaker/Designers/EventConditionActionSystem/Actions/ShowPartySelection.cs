...
public class ShowPartySelection : GameAction
{
	...
	public bool AllowRemoteCompanionsAnywhere;
	...
	protected override void RunAction()
	{
		...
		EventBus.RaiseEvent(delegate(IGroupChangerHandler h)
		{
			...
			}, Game.Instance.LoadedAreaState.Settings.CapitalPartyMode, allMatchFinishActions, !ActionsCannotBeCanceled, AllowRemoteCompanionsAnywhere);
		});
	}
