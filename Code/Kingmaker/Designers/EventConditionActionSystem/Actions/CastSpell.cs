...
public class CastSpell : GameAction
{
	...
	protected override void RunAction()
	{
		...
		TargetWrapper abilityTarget = (TargetWrapper)obj;
		RulePerformAbility rulePerformAbility = new RulePerformAbility(new AbilityData(Ability, mechanicEntity), abilityTarget);
