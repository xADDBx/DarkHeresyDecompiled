...
public class TeleportParty : GameAction, IAreaEnterPointReference
{
	...
	protected override void RunAction()
	{
		...
		LoadingProcess.Instance.StartLoadingProcess("TeleportParty", delegate
		{
	...
	private void Save()
	{
		LoadingProcess.Instance.StartLoadingProcess("SaveRoutine (teleport autosave)", Game.Instance.SaveManager.SaveRoutine(Game.Instance.SaveManager.GetNextAutoslot()));
	}
