...
public class UseActionPoints : GameAction
{
	...
	protected override void RunAction()
	{
		...
		{
			baseUnitEntity.CombatState.SpendActionPoints(AP);
			baseUnitEntity.CombatState.SpendMovementPoints(MP);
			if (EndTurn && Game.Instance.Controllers.TurnController.CurrentUnit == baseUnitEntity)
			{
