...
[TypeId("5b2bb7b761bf72f438dbf236658d2d75")]
public class HideScriptZoneUnit : GameAction
{
	...
	protected override void RunAction()
	{
		...
		ScriptZoneEntity scriptZoneEntity = ContextData<ScriptZoneTriggerData>.Current?.State?.AllEntityData.OfType<ScriptZoneEntity>().FirstOrDefault();
		if (scriptZoneEntity == null)
		{
			if (LogAction)
			{
				PFLog.Default.Error("HideScriptZoneUnit: Cannot find ScriptZoneEntity");
			}
			return;
		}
	...
	private void UnhideUnits()
	{
		...
		if (TargetScriptZone != null)
		{
			scriptZoneEntity = TargetScriptZone.FindData() as ScriptZoneEntity;
		}
		else
		{
			...
			{
				scriptZoneEntity = sceneEntitiesState.AllEntityData.OfType<ScriptZoneEntity>().FirstOrDefault();
			}
		}
		if (scriptZoneEntity == null)
		{
