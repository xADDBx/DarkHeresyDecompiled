...
public class AnswerListShown : Condition
{
	...
	protected override bool CheckCondition()
	{
		if (!CurrentDialog)
		{
			return Game.Instance.DialogState.ShownAnswerListsContains(AnswersList);
		}
		return Game.Instance.Controllers.DialogController.LocalShownAnswerLists.Contains(AnswersList);
	}
}
