...
public class EtudeStatus : Condition, IEtudeReference
{
	...
	{
		Etude etude = Game.Instance.EtudesSystem.Etudes.Get(Etude);
		if (Game.Instance.EtudesSystem.EtudeIsNotStarted(Etude))
		{
			return NotStarted;
		}
		if (Game.Instance.EtudesSystem.EtudeIsCompleted(Etude))
		{
			return Completed;
		}
