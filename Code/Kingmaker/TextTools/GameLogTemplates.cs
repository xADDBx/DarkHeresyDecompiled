...
public static class GameLogTemplates
{
	...
	public static readonly TextTemplate BodyPartD100 = new LogTemplateDice<IRuleRollD100>(() => GameLogContext.BodyPartD100.Value);

	public static readonly TextTemplate DefenceD100 = new LogTemplateDice<IRuleRollD100>(() => GameLogContext.DefenceD100.Value);
