...
public class MaleFemaleTemplate : TextTemplate
{
	...
	{
		int num = (int)(((MechanicEntity)((GameLogContext.InScope ? GameLogContext.SourceEntity.Value : null) ?? Game.Instance.Controllers.DialogController.ActingUnit ?? Game.Instance.Player.MainCharacterEntity))?.GetDescriptionOptional()?.Gender).GetValueOrDefault();
