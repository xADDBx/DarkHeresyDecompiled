...
public class ControlsKeybindingsGeneralSettings
{
	...
	public readonly SettingsEntityKeyBindingPair OpenDetectiveJournal;
	...
	public readonly SettingsEntityKeyBindingPair EndPreparationTurn;
	...
	public readonly SettingsEntityKeyBindingPair ToggleFullUnitInfo;

	public readonly SettingsEntityKeyBindingPair ScrollUp;

	public readonly SettingsEntityKeyBindingPair ScrollDown;

	public readonly SettingsEntityKeyBindingPair ScrollLeft;

	public readonly SettingsEntityKeyBindingPair ScrollRight;
	...
	public ControlsKeybindingsGeneralSettings(ISettingsController settingsController, ControlsKeybindingsGeneralSettingsDefaultValues defaultValues)
	{
		...
		OpenDetectiveJournal = new SettingsEntityKeyBindingPair(settingsController, "open-detective-journal", defaultValues.OpenDetectiveJournal);
		...
		EndPreparationTurn = new SettingsEntityKeyBindingPair(settingsController, "end-preparation-turn", defaultValues.EndPreparationTurn);
		...
		ToggleFullUnitInfo = new SettingsEntityKeyBindingPair(settingsController, "show-full-unit-info", defaultValues.ToggleFullUnitInfo);
		ScrollUp = new SettingsEntityKeyBindingPair(settingsController, "scroll-up", defaultValues.ScrollUp);
		ScrollDown = new SettingsEntityKeyBindingPair(settingsController, "scroll-down", defaultValues.ScrollDown);
		ScrollLeft = new SettingsEntityKeyBindingPair(settingsController, "scroll-left", defaultValues.ScrollLeft);
		ScrollRight = new SettingsEntityKeyBindingPair(settingsController, "scroll-right", defaultValues.ScrollRight);
	}
}
