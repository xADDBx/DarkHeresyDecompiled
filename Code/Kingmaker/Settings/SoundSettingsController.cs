...
public class SoundSettingsController
{
	...
	private void SettingsToRealMasterVolume()
	{
		...
		AkUnitySoundEngine.SetRTPCValue("AudioLevel", tempValue, null, 0);
	}

	private void SettingsToRealMusicVolume()
	{
		float tempValue = m_Settings.VolumeMusic.GetTempValue();
		AkUnitySoundEngine.SetRTPCValue("MusicLevel", tempValue, null, 0);
	}

	private void SettingsVoicesVolume(float v)
	{
		AkUnitySoundEngine.SetRTPCValue("VoiceLevel", v, null, 0);
	}

	private void SettingsVoicesCharacterInGameVolume(float v)
	{
		AkUnitySoundEngine.SetRTPCValue("CharactersLevel", v, null, 0);
	}

	private void SettingsVoicesNpcInGameVolume(float v)
	{
		AkUnitySoundEngine.SetRTPCValue("NPCLevel", v, null, 0);
	}

	private void SettingsVoicesDialoguesVolume(float v)
	{
		AkUnitySoundEngine.SetRTPCValue("DialogueLevel", v, null, 0);
	}

	private void SettingsSfxVolume(float v)
	{
		AkUnitySoundEngine.SetRTPCValue("SFXLevel", v, null, 0);
	}

	private void SettingsAmbienceVolume(float v)
	{
		AkUnitySoundEngine.SetRTPCValue("AmbienceLevel", v, null, 0);
	}

	private void SettingsAbilitiesVolume(float v)
	{
		AkUnitySoundEngine.SetRTPCValue("AbilitiesLevel", v, null, 0);
	}

	private void SettingsRangedWeaponsVolume(float v)
	{
		AkUnitySoundEngine.SetRTPCValue("RWeaponsLevel", v, null, 0);
	}

	private void SettingsMeleeWeaponsVolume(float v)
	{
		AkUnitySoundEngine.SetRTPCValue("MWeaponsLevel", v, null, 0);
	}

	private void SettingsHitsLevelVolume(float v)
	{
		AkUnitySoundEngine.SetRTPCValue("HitsLevel", v, null, 0);
	}

	private void SettingsUIVolume(float v)
	{
		AkUnitySoundEngine.SetRTPCValue("UILevel", v, null, 0);
	}
}
