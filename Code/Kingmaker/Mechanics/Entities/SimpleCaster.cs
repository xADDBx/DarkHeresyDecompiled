...
public class SimpleCaster : SimpleMechanicEntity, IHashable, IOwlPackable<SimpleCaster>
{
	...
	public SimpleCaster(int index)
		: base("simple_caster_" + index, isInGame: true, ConfigRoot.Instance.SystemMechanics.DefaultMapObjectBlueprint)
	{
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<SimpleCaster>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<SimpleCaster>();
