...
public static class DamageExtension
{
	...
	public static IntermediateDamage CreateDamage(this DamageType type, int value)
	{
		return new IntermediateDamage(type, value);
	}

	public static IntermediateDamage CreateDamage(this DamageType type, int min, int max)
	{
		return new IntermediateDamage(type, min, max);
	}

	public static IntermediateDamage CreateDamage(this DamageType type, DiceFormula dice, int bonus = 0)
	{
		return new IntermediateDamage(type, dice.MinValue(bonus), dice.MaxValue(bonus));
	}
