	...
	protected override void RunAction()
	{
		...
		foreach (LosCalculations.CoverType coverType in coverTypesInPreferrableOrder)
		{
			...
			if (!dictionary[coverType].Empty())
			{
				...
				GraphNode node2 = source.First();
				WarhammerPathPlayer warhammerPathPlayer = PathfindingService.Instance.FindPathTB_Blocking(baseUnitEntity.View.MovementAgent, node2.Vector3Position(), limitRangeByActionPoints: false);
