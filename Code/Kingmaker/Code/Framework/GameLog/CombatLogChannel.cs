...
public class CombatLogChannel : BaseDisposable
{
	...
	public ObservableList<CombatLogMessage> Messages;
	...
	public CombatLogChannel(List<LogThreadBase> channelThreads, string channelName)
	{
		...
		Messages = new ObservableList<CombatLogMessage>(list.OrderBy((CombatLogMessage z) => z.Received));
	...
	private void AddNewMessage(CombatLogMessage newMessage)
	{
