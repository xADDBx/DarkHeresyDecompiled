...
public static class SizePathfindingHelper
{
	...
	public static Vector3 GetSizePositionOffset(Size size)
	{
		return GetSizePositionOffsetForGroundUnit(size).To3D();
	}
	...
	{
		return FromMechanicsToViewPosition(entity, mechanicsPosition, Game.Instance.Controllers.TurnController.TurnBasedModeActive);
	}
	...
	{
		return FromViewToMechanicsPosition(entity, mechanicsPosition, Game.Instance.Controllers.TurnController.TurnBasedModeActive);
	}
