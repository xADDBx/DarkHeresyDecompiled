...
public class ItemEntityMechadendrite : ItemEntity<BlueprintItemMechadendrite>, IHashable, IOwlPackable<ItemEntityMechadendrite>
{
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<ItemEntityMechadendrite>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<ItemEntityMechadendrite>();
