...
public class PartUnitBody : BaseUnitPart, IUnitInventoryChanged<EntitySubscriber>, IUnitInventoryChanged, ISubscriber<IBaseUnitEntity>, ISubscriber, IEventTag<IUnitInventoryChanged, EntitySubscriber>, IHashable, IOwlPackable<PartUnitBody>
{
	...
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		...
		{
			new FieldInfo("m_CurrentHandsEquipmentSetIndex", typeof(int)),
			new FieldInfo("m_HandsEquipmentSets", typeof(HandsEquipmentSet[])),
			new FieldInfo("m_AdditionalLimbs", typeof(List<WeaponSlot>)),
			new FieldInfo("m_PolymorphHandsEquipmentSet", typeof(HandsEquipmentSet)),
			new FieldInfo("m_PolymorphAdditionalLimbs", typeof(List<WeaponSlot>)),
			new FieldInfo("m_PolymorphKeepSlots", typeof(bool)),
			new FieldInfo("QuickSlots", typeof(UsableSlot[])),
			new FieldInfo("Armor", typeof(ArmorSlot)),
			new FieldInfo("Shirt", typeof(EquipmentSlot<BlueprintItemEquipmentShirt>)),
			new FieldInfo("Belt", typeof(EquipmentSlot<BlueprintItemEquipmentBelt>)),
			new FieldInfo("Head", typeof(EquipmentSlot<BlueprintItemEquipmentHead>)),
			new FieldInfo("Glasses", typeof(EquipmentSlot<BlueprintItemEquipmentGlasses>)),
			new FieldInfo("Feet", typeof(EquipmentSlot<BlueprintItemEquipmentFeet>)),
			new FieldInfo("Gloves", typeof(EquipmentSlot<BlueprintItemEquipmentGloves>)),
			new FieldInfo("Neck", typeof(EquipmentSlot<BlueprintItemEquipmentNeck>)),
			new FieldInfo("Ring1", typeof(EquipmentSlot<BlueprintItemEquipmentRing>)),
			new FieldInfo("Ring2", typeof(EquipmentSlot<BlueprintItemEquipmentRing>)),
			new FieldInfo("Wrist", typeof(EquipmentSlot<BlueprintItemEquipmentWrist>)),
			new FieldInfo("Shoulders", typeof(EquipmentSlot<BlueprintItemEquipmentShoulders>)),
			new FieldInfo("Mechadendrites", typeof(List<EquipmentSlot<BlueprintItemMechadendrite>>)),
			new FieldInfo("InCombatVisual", typeof(bool))
		}
	};

	[JsonProperty]
	[OwlPackInclude]
	private List<WeaponSlot> m_AdditionalLimbs { get; set; } = new List<WeaponSlot>();
	...
	[CanBeNull]
	public HandsEquipmentSet GetHandsEquipmentSet(ItemSlot slot)
	{
	...
	public int? GetHandsEquipmentSetIndex(ItemSlot slot)
	{
		if (!(slot is HandSlot))
		{
			return null;
	...
	public int? GetHandsEquipmentSetIndex(ItemEntity item)
	{
		return GetHandsEquipmentSetIndex(item.HoldingSlot);
	}

	public int? GetHandsEquipmentSlotIndex(ItemSlot slot)
	{
		if (!(slot is HandSlot slot2))
		{
			return null;
		}
		HandsEquipmentSet handsEquipmentSet = GetHandsEquipmentSet(slot2);
	...
	public int? GetHandsEquipmentSlotIndex(ItemEntity item)
	{
		return GetHandsEquipmentSlotIndex(item.HoldingSlot);
	}
	...
	{
		PartUnitBody source = new PartUnitBody();
		result = Unsafe.As<PartUnitBody, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<PartUnitBody>(OwlPackTypeInfo);
		formatter.StartObject(type, OwlPackTypeInfo.Name, objectId);
		formatter.UnmanagedField(0, "m_CurrentHandsEquipmentSetIndex", ref m_CurrentHandsEquipmentSetIndex, state);
		formatter.Field(1, "m_HandsEquipmentSets", ref m_HandsEquipmentSets, state);
		List<WeaponSlot> value = m_AdditionalLimbs;
		formatter.Field(2, "m_AdditionalLimbs", ref value, state);
		formatter.Field(3, "m_PolymorphHandsEquipmentSet", ref m_PolymorphHandsEquipmentSet, state);
		formatter.Field(4, "m_PolymorphAdditionalLimbs", ref m_PolymorphAdditionalLimbs, state);
		formatter.UnmanagedField(5, "m_PolymorphKeepSlots", ref m_PolymorphKeepSlots, state);
		formatter.Field(6, "QuickSlots", ref QuickSlots, state);
		formatter.Field(7, "Armor", ref Armor, state);
		formatter.Field(8, "Shirt", ref Shirt, state);
		formatter.Field(9, "Belt", ref Belt, state);
		formatter.Field(10, "Head", ref Head, state);
		formatter.Field(11, "Glasses", ref Glasses, state);
		formatter.Field(12, "Feet", ref Feet, state);
		formatter.Field(13, "Gloves", ref Gloves, state);
		formatter.Field(14, "Neck", ref Neck, state);
		formatter.Field(15, "Ring1", ref Ring1, state);
		formatter.Field(16, "Ring2", ref Ring2, state);
		formatter.Field(17, "Wrist", ref Wrist, state);
		formatter.Field(18, "Shoulders", ref Shoulders, state);
		formatter.Field(19, "Mechadendrites", ref Mechadendrites, state);
		bool value2 = InCombatVisual;
		formatter.UnmanagedField(20, "InCombatVisual", ref value2, state);
		formatter.EndObject();
	}
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<PartUnitBody>();
		...
		for (int i = 0; i < typeInfo.Fields.Length; i++)
		{
			...
			case byte.MaxValue:
				...
				break;
			case 0:
				m_CurrentHandsEquipmentSetIndex = formatter.ReadUnmanaged<int>(state);
				break;
			case 1:
				m_HandsEquipmentSets = formatter.ReadPackable<HandsEquipmentSet[]>(state);
				break;
			case 2:
				m_AdditionalLimbs = formatter.ReadPackable<List<WeaponSlot>>(state);
				break;
			case 3:
				m_PolymorphHandsEquipmentSet = formatter.ReadPackable<HandsEquipmentSet>(state);
				break;
			case 4:
				m_PolymorphAdditionalLimbs = formatter.ReadPackable<List<WeaponSlot>>(state);
				break;
			case 5:
				m_PolymorphKeepSlots = formatter.ReadUnmanaged<bool>(state);
				break;
			case 6:
				QuickSlots = formatter.ReadPackable<UsableSlot[]>(state);
				break;
			case 7:
				Armor = formatter.ReadPackable<ArmorSlot>(state);
				break;
			case 8:
				Shirt = formatter.ReadPackable<EquipmentSlot<BlueprintItemEquipmentShirt>>(state);
				break;
			case 9:
				Belt = formatter.ReadPackable<EquipmentSlot<BlueprintItemEquipmentBelt>>(state);
				break;
			case 10:
				Head = formatter.ReadPackable<EquipmentSlot<BlueprintItemEquipmentHead>>(state);
				break;
			case 11:
				Glasses = formatter.ReadPackable<EquipmentSlot<BlueprintItemEquipmentGlasses>>(state);
				break;
			case 12:
				Feet = formatter.ReadPackable<EquipmentSlot<BlueprintItemEquipmentFeet>>(state);
				break;
			case 13:
				Gloves = formatter.ReadPackable<EquipmentSlot<BlueprintItemEquipmentGloves>>(state);
				break;
			case 14:
				Neck = formatter.ReadPackable<EquipmentSlot<BlueprintItemEquipmentNeck>>(state);
				break;
			case 15:
				Ring1 = formatter.ReadPackable<EquipmentSlot<BlueprintItemEquipmentRing>>(state);
				break;
			case 16:
				Ring2 = formatter.ReadPackable<EquipmentSlot<BlueprintItemEquipmentRing>>(state);
				break;
			case 17:
				Wrist = formatter.ReadPackable<EquipmentSlot<BlueprintItemEquipmentWrist>>(state);
				break;
			case 18:
				Shoulders = formatter.ReadPackable<EquipmentSlot<BlueprintItemEquipmentShoulders>>(state);
				break;
			case 19:
				Mechadendrites = formatter.ReadPackable<List<EquipmentSlot<BlueprintItemMechadendrite>>>(state);
				break;
			case 20:
				InCombatVisual = formatter.ReadUnmanaged<bool>(state);
				break;
			}
		}
