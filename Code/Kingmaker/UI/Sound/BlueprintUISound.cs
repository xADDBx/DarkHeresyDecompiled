...
public class BlueprintUISound : BlueprintScriptableObject
{
	...
	public class UISoundInventory : ServiceWindowUISound
	{
		...
		public UISound InventoryRotateDollStart;

		public UISound InventoryRotateDollLoopStart;

		public UISound InventoryRotateDollLoopStop;

		public UISound InventoryRotateDollStop;

		public UISound InventoryResetDollPosition;
	}
	...
	public class UISoundCharacter : ServiceWindowUISound
	{
		...
		public UISound PaperTabChanged;
	}
	...
	{
		public UISound ZoomInButton;

		public UISound ZoomOutButton;

		public UISound ResetZoomAndPositionButton;

		public UISound ZoomInScroll;

		public UISound ZoomOutScroll;
	}
	...
	public class UISoundLoot
	{
		...
		{
			public LootWindowMode WindowMode;

			public UISound SoundWindowOpen;

			public UISound SoundWindowClose;
		}
		...
		public UISound InsertableLootDrop;

		public UISound LootDefaultWindowOpen;

		public UISound LootDefaultWindowClose;

		public List<LootSoundEntry> LootSounds = new List<LootSoundEntry>();
	...
	public class UISoundNotifications
	{
		...
		public UISound CompletedQuest;

		public UISound NewDetectiveCase;

		public UISound NewDetectiveInformation;
	}
	...
	public class UISoundButtons
	{
		...
		public UISound PaperButtonHover;

		public UISound PaperButtonClick;

		public UISound MajorPaperButtonHover;

		public UISound MajorPaperButtonClick;
	}
	...
	public class UISoundCombat
	{
		...
		public UISound CombatGridClearWaypoint;
		...
		public UISound PrecisionShotOn;

		public UISound PrecisionShotOff;

		public UISound PrecisionShotTargetChange;

		public UISound PreparationTurnDeployUnit;

		public UISound CursorNotificationMessage;
	}
	...
	[Serializable]
	public class UIDetectiveSystem
	{
		public UISound SignalDevice;

		public UISound SignalDeviceShow;

		public UISound SignalDeviceHide;

		public UISound CaseDescriptionShow;

		public UISound ClueDisplayInformationShow;

		public UISound ClueDisplayInformationTextStart;

		public UISound ClueDisplayInformationTextStop;

		public UISound ConclusionSelectionSelectConclusion;

		public UISound ConclusionSelectionApplyConclusion;

		public UISound SetLineTargetDot;

		public UISound ClueResearch;

		public UISound ClueResearchComplete;

		public UISound CaseItemDragStart;

		public UISound CaseItemDragStop;
	}

	[Serializable]
	public class UIInteractionSounds
	{
		public UISound InteractionWindowOpen;

		public UISound InteractionWindowClosed;

		public List<InteractionSoundEntry> Interactions;
	...
	{
		public UIInteractionType Type;

		public UISound SoundSuccess;

		public UISound SoundFail;
	}
	...
	{
		[SerializeField]
		private UISound m_Open;

		[SerializeField]
		private UISound m_Close;

		[SerializeField]
		private UISound m_SwitchTo;
	...
	public UISoundDetectiveJournal DetectiveJournal;

	public UISoundFactions Factions;

	[Header("To Be Sorted")]
	public UISoundCommonControls Common;
	...
	public UISoundNotifications Notifications;
	...
	public UIDetectiveSystem DetectiveSystem;

	public UIInteractionSounds InteractionSounds;
	...
	{
		GetServiceWindow(type)?.PlayOpen();
	}

	public void PlayCloseSound(ServiceWindowsType type)
	{
		GetServiceWindow(type)?.PlayClose();
	}

	public void PlaySwitchSound(ServiceWindowsType type)
	{
		GetServiceWindow(type)?.PlaySwitch();
	}

	public ServiceWindowUISound GetServiceWindow(ServiceWindowsType type)
	{
		return type switch
		{
