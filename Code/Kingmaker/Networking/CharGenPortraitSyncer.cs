...
public class CharGenPortraitSyncer : IProgress<DataTransferProgressInfo>
{
	...
	private readonly ReactiveProperty<float> m_LoadingPortraitProgress = new ReactiveProperty<float>();

	private readonly ReactiveCommand<Unit> m_LoadingPortraitProgressCloseTrigger = new ReactiveCommand<Unit>();
	...
	private void ShowUI()
	{
		...
		{
			w.HandleOpen(waitMessage, DialogMessageBoxType.ProgressBar, null, null, null, null, null, null, null, 0, uint.MaxValue, m_LoadingPortraitProgress, m_LoadingPortraitProgressCloseTrigger);
		});
	}
