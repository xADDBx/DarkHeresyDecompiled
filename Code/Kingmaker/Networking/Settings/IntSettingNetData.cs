...
public sealed class IntSettingNetData : TypedBaseSettingNetData<int>, IMemoryPackable<IntSettingNetData>, IMemoryPackFormatterRegister
{
	...
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref IntSettingNetData value)
		{
			IntSettingNetData.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref IntSettingNetData value)
		{
			IntSettingNetData.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref IntSettingNetData value)
		{
			IntSettingNetData.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref IntSettingNetData? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref IntSettingNetData? value)
	{
		...
		if (memberCount == 250)
		{
			...
			value = (IntSettingNetData)reader.OptionalState.GetObjectReference(id);
			return;
		}
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref IntSettingNetData? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref IntSettingNetData? value)
	{
