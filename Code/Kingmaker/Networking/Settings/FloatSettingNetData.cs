...
public sealed class FloatSettingNetData : TypedBaseSettingNetData<float>, IMemoryPackable<FloatSettingNetData>, IMemoryPackFormatterRegister
{
	...
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref FloatSettingNetData value)
		{
			FloatSettingNetData.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref FloatSettingNetData value)
		{
			FloatSettingNetData.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref FloatSettingNetData value)
		{
			FloatSettingNetData.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref FloatSettingNetData? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref FloatSettingNetData? value)
	{
		...
		if (memberCount == 250)
		{
			...
			value = (FloatSettingNetData)reader.OptionalState.GetObjectReference(id);
			return;
		}
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref FloatSettingNetData? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref FloatSettingNetData? value)
	{
			...
			while ((text = reader.ReadPropertyName()) != null)
			{
				if (value == null)
				{
					if (!(text == "Index"))
					{
						if (text == "Value")
						{
							reader.ReadUnmanaged<float>(out v2);
							array[1] = true;
						}
					}
					else
