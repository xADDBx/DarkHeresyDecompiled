...
internal class BaseSettingNetDataFormatter : MemoryPackFormatter<BaseSettingNetData>
{
	...
	[Preserve]
	public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref BaseSettingNetData? value)
	{
		ushort value2;
		if (value == null)
		{
	...
	public override void SerializeJson(ref MemoryPackJsonWriter writer, ref BaseSettingNetData? value)
	{
		ushort value2;
		if (value == null)
		{
		...
		else if (__typeToTag.TryGetValue(value.GetType(), out value2))
		{
			...
			{
			case 0:
				writer.WritePackable(Unsafe.As<BaseSettingNetData, BoolSettingNetData>(ref value));
				break;
			case 1:
				writer.WritePackable(Unsafe.As<BaseSettingNetData, IntSettingNetData>(ref value));
				break;
			case 2:
				writer.WritePackable(Unsafe.As<BaseSettingNetData, FloatSettingNetData>(ref value));
				break;
			case 3:
				writer.WritePackable(Unsafe.As<BaseSettingNetData, EnumSettingNetData>(ref value));
				break;
			}
	...
	[Preserve]
	public override void DeserializeJson(ref MemoryPackJsonReader reader, ref BaseSettingNetData? value)
	{
		if (!reader.TryReadUnionHeader(out var tag))
		{
			value = null;
