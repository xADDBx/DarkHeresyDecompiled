...
public static class AnalyticsHelper
{
	...
	public static string GetPlayerLevels()
	{
		...
		return $"{Game.Instance.Player.MainCharacterEntity.Progression.ExperienceLevel}:" + $"{(int)SettingsRoot.Difficulty.GameDifficulty}:" + Game.Instance.Statistic.m_gameSessionGUID + empty;
	}
