...
[TypeId("040d9e18ab38aaf4dabd1edc986dc850")]
public class TutorialTriggerEnemyHasFact : TutorialTriggerEnterCombatWithUnit
{
	...
	protected override bool IsSuitableUnit(BaseUnitEntity unit)
	{
		...
		while (enumerator.MoveNext())
		{
			...
			if (!(current == null) && (m_AllowItemsWithSpell || current.SourceItem == null) && Spells.ContainsAbility(current.Blueprint))
			{
