...
public readonly struct WarhammerPathAiCell
{
	...
	public WarhammerPathAiCell(Vector3 position, int diagonalsCount, float length, GraphNode node, GraphNode parentNode, bool isCanStand, int enteredAoE, int leavedAoE, int stepsInsideDamagingAoE, int provokedAttacks)
	{
		Position = position;
