...
public class RulePerformSummonUnit : RulebookEvent
{
	...
	public override void OnTrigger(RulebookEventContext context)
	{
		...
		BaseUnitEntity baseUnitEntity = Game.Instance.Controllers.EntitySpawner.SpawnUnit(Blueprint, Position, Quaternion.identity, (!flag) ? base.ConcreteInitiator.HoldingState : null);
		...
		if (Context != null)
		{
			baseUnitEntity.Buffs.Add(ConfigRoot.Instance.SystemMechanics.SummonedUnitBuff, Context, value);
		}
		else
		{
			baseUnitEntity.Buffs.Add(ConfigRoot.Instance.SystemMechanics.SummonedUnitBuff, base.ConcreteInitiator, null, value);
		}
		...
		SummonedUnit.Buffs.Add(ConfigRoot.Instance.SystemMechanics.SummonedUnitAppearBuff, Context, 1.Rounds());
		if (SettingsRoot.Game.TurnBased.EnableTurnBasedMode)
		{
			SummonedUnit.Facts.Remove(ConfigRoot.Instance.SystemMechanics.SummonedUnitAppearBuff);
		}
	}
