...
public class SummonedUnitsController : BaseUnitController
{
	...
	private static void TickUnitFollowMaster(AbstractUnitEntity unit, UnitPartSummonedMonster part)
	{
		...
		PathCursor pathCursor = unitEntity.View.MovementAgent.PathCursor;
		Vector3 vector = (pathCursor.HasPath ? pathCursor.LastWaypoint3D_SizeAdjusted : part.Summoner.Position);
