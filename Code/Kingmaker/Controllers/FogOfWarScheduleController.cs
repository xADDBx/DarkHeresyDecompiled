...
public class FogOfWarScheduleController : IControllerTick, IController, IControllerStop, IControllerStart
{
	...
	public void OnStart()
	{
		...
		((IControllerTick)Game.Instance.Controllers.FogOfWarComplete).Tick();
	}
	...
	private static bool IsRevealer(BaseUnitEntity unit)
	{
		...
		{
			return unit.Faction.IsPlayer && Game.Instance.Player.PartyAndPets.HasItem(unit) && unit.View != null && unit.IsViewActive && !unit.LifeState.IsDead;
		}
	}
