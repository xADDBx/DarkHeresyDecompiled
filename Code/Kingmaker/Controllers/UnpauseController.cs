...
public class UnpauseController : IControllerEnable, IController, IControllerDisable, IControllerTick
{
	...
	public void Tick()
	{
		...
		Game.Instance.Controllers.TimeController.PlayerTimeScale = (Game.Instance.InvertPauseButtonPressed ? 0.6f : 1f);
	}
	...
	{
		Game.Instance.Controllers.TimeController.PlayerTimeScale = 1f;
	}
}
