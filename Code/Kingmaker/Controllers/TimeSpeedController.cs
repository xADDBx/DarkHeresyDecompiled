...
public class TimeSpeedController : IControllerTick, IController
{
	public struct AutoSpeed
	{
		...
		public void Tick(TimeSpeedController timeSpeedController)
		{
			...
			PlayerCommandsCollection<SynchronizedData> synchronizedData = Game.Instance.Controllers.SynchronizedDataController.SynchronizedData;
	...
	{
		int maxLag = Game.Instance.Controllers.SynchronizedDataController.SynchronizedData.GetMaxLag();
	...
	public void OnEnoughTimeToProcess(int tick)
	{
		if (m_LastTick != tick)
		{
			...
			int maxReadyTick = Game.Instance.Controllers.UnitCommandBuffer.GetMaxReadyTick();
