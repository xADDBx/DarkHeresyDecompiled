...
public class EntityBoundsPart : EntityPart, IEntityPositionChangedHandler<EntitySubscriber>, IEntityPositionChangedHandler, ISubscriber<IEntity>, ISubscriber, IEventTag<IEntityPositionChangedHandler, EntitySubscriber>, IUnitSizeHandler<EntitySubscriber>, IUnitSizeHandler, ISubscriber<IMechanicEntity>, IEntitySubscriber, IEventTag<IUnitSizeHandler, EntitySubscriber>, IInGameHandler<EntitySubscriber>, IInGameHandler, IEventTag<IInGameHandler, EntitySubscriber>, BaseUnitEntity.IUnitAsleepHandler<EntitySubscriber>, AbstractUnitEntity.IUnitAsleepHandler, IEventTag<AbstractUnitEntity.IUnitAsleepHandler, EntitySubscriber>, EntityBoundsController.IHasTick, IHashable, IOwlPackable<EntityBoundsPart>
{
	...
	protected override void OnViewWillDetach()
	{
		...
		DestroyColliders();
		Game.Instance.Controllers.EntityBoundsController.CancelUpdate(m_UpdateNode);
	}
	...
	private void ScheduleUpdate()
	{
		...
		{
			Game.Instance.Controllers.EntityBoundsController.ScheduleUpdate(m_UpdateNode);
		}
	}
	...
	{
		EntityBoundsPart source = new EntityBoundsPart();
		result = Unsafe.As<EntityBoundsPart, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<EntityBoundsPart>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<EntityBoundsPart>();
