...
{
	private readonly Dictionary<GridNodeBase, LosCalculations.CoverType> m_Cache = new Dictionary<GridNodeBase, LosCalculations.CoverType>();
	...
	public void Tick()
	{
		...
		{
			foreach (GridNodeBase node in registeredCoverProvider.Nodes)
			{
