...
public class RealTimeController
{
	...
	{
		commandsReady = true;
		Player entity = Player.Ref.Entity;
		if (entity == null)
		{
			return false;
		}
		TimeSpan realTime = entity.RealTime;
	...
	{
		int tickIndex = Game.Instance.Controllers.TimeSpeedController.GetTickIndex(currentTickIndex + 1);
	...
	public void Tick()
	{
		...
		if (flag)
		{
			...
			{
				Game.Instance.Controllers.TimeSpeedController.OnEnoughTimeToProcess(CurrentNetworkTick);
			}
		}
