...
{
	void HandleCall(Action goAction, Action closeAction, bool isCapital, bool sameFinishActions = false, bool canCancel = true, bool allowRemoteCompanionsEverywhere = false);
