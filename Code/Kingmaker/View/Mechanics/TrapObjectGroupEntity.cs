...
[OwlPackOldName("Kingmaker.View.Mechanics.TrapObjectGroupView+MechanicGroupData")]
public sealed class TrapObjectGroupEntity : MechanicGroupEntity, IOwlPackable<TrapObjectGroupEntity>
{
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		Name = "TrapObjectGroupEntity",
		OldNames = new string[1] { "Kingmaker.View.Mechanics.TrapObjectGroupView+MechanicGroupData" },
	...
	public TrapObjectGroupEntity(IEntityGroupConfig config)
		: base(config)
	{
	}

	public TrapObjectGroupEntity(OwlPackConstructorParameter _)
		: base(_)
	{
	}
	...
	{
		TrapObjectGroupEntity source = new TrapObjectGroupEntity(default(OwlPackConstructorParameter));
		result = Unsafe.As<TrapObjectGroupEntity, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<TrapObjectGroupEntity>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<TrapObjectGroupEntity>();
