...
public class TrapObjectGroupView : MechanicGroupView<TrapObjectView>
{
	...
	public new class MechanicGroupData : MechanicGroupView<TrapObjectView>.MechanicGroupData, IOwlPackable<MechanicGroupData>
	{
	...
	protected override void OnActivate()
	{
		...
		foreach (TrapObjectView trapObjectView in childrenViews)
		{
			...
			Game.Instance.Controllers.EntitySpawner.SpawnEntityWithView(trapObjectView.Settings.ScriptZoneTrigger, Game.Instance.LoadedAreaState.MainState, moveView: false);
		}
	}
