...
[OwlPackOldName("Kingmaker.View.Mechanics.AreaEffectGroupView+MechanicGroupData")]
public sealed class AreaEffectGroupEntity : MechanicGroupEntity, IOwlPackable<AreaEffectGroupEntity>
{
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		Name = "AreaEffectGroupEntity",
		OldNames = new string[1] { "Kingmaker.View.Mechanics.AreaEffectGroupView+MechanicGroupData" },
	...
	public AreaEffectGroupEntity(IEntityGroupConfig config)
		: base(config)
	{
	}

	public AreaEffectGroupEntity(OwlPackConstructorParameter _)
		: base(_)
	{
	}
	...
	{
		AreaEffectGroupEntity source = new AreaEffectGroupEntity(default(OwlPackConstructorParameter));
		result = Unsafe.As<AreaEffectGroupEntity, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<AreaEffectGroupEntity>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<AreaEffectGroupEntity>();
