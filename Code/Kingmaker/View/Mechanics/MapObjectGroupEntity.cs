...
[OwlPackOldName("Kingmaker.View.Mechanics.MapObjectGroupView+MechanicGroupData")]
public sealed class MapObjectGroupEntity : MechanicGroupEntity, IOwlPackable<MapObjectGroupEntity>
{
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		Name = "MapObjectGroupEntity",
		OldNames = new string[1] { "Kingmaker.View.Mechanics.MapObjectGroupView+MechanicGroupData" },
	...
	public MapObjectGroupEntity(IEntityGroupConfig config)
		: base(config)
	{
	}

	public MapObjectGroupEntity(OwlPackConstructorParameter _)
		: base(_)
	{
	}
	...
	{
		MapObjectGroupEntity source = new MapObjectGroupEntity(default(OwlPackConstructorParameter));
		result = Unsafe.As<MapObjectGroupEntity, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<MapObjectGroupEntity>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<MapObjectGroupEntity>();
