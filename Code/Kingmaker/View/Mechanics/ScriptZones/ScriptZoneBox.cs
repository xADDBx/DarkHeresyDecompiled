...
public class ScriptZoneBox : ScriptZoneShape
{
	...
	public override NodeList CoveredNodes => GridAreaHelper.GetNodes(EditorGridHelper.GetNodesInsideScriptZone(this));
	...
	public override Bounds GetBounds()
	{
		...
		return new Bounds(base.transform.position + Bounds.center, new Vector3(num3, Bounds.size.y * lossyScale.y, num3));
	}
