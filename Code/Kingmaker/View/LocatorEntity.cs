...
public class LocatorEntity : Entity, IHashable, IOwlPackable<LocatorEntity>
{
	...
	public override bool IsVisibleForPlayer
	{
		get
		{
			if (!base.IsInFogOfWar && base.View != null)
			{
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<LocatorEntity>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<LocatorEntity>();
