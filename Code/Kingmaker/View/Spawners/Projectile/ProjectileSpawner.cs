...
public class ProjectileSpawner : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		Game.Instance.Controllers.ProjectileSpawnerController.RegisterSpawner(this);
	}

	private void OnDisable()
	{
		Game.Instance.Controllers.ProjectileSpawnerController.UnregisterSpawner(this);
	}
