...
[OwlPackOldName("Kingmaker.View.Spawners.UnitGroupView+UnitGroupData")]
public sealed class UnitGroupEntity : AbstractEntityGroup, IHashable, IOwlPackable<UnitGroupEntity>
{
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		Name = "UnitGroupEntity",
		OldNames = new string[1] { "Kingmaker.View.Spawners.UnitGroupView+UnitGroupData" },
	...
	public UnitGroupEntity(IEntityGroupConfig config)
		: base(config)
	{
	}

	public UnitGroupEntity(OwlPackConstructorParameter _)
		: base(_)
	{
	}
	...
	{
		UnitGroupEntity source = new UnitGroupEntity(default(OwlPackConstructorParameter));
		result = Unsafe.As<UnitGroupEntity, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitGroupEntity>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitGroupEntity>();
