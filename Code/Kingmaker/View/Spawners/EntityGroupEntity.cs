...
[OwlPackOldName("Kingmaker.View.Spawners.EntityGroupView+UnitGroupData")]
public class EntityGroupEntity : AbstractEntityGroup, IHashable, IOwlPackable<EntityGroupEntity>
{
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		Name = "EntityGroupEntity",
		OldNames = new string[1] { "Kingmaker.View.Spawners.EntityGroupView+UnitGroupData" },
	...
	public EntityGroupEntity(IEntityGroupConfig config)
		: base(config)
	{
	}

	public EntityGroupEntity(OwlPackConstructorParameter _)
		: base(_)
	{
	}
	...
	{
		EntityGroupEntity source = new EntityGroupEntity(default(OwlPackConstructorParameter));
		result = Unsafe.As<EntityGroupEntity, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<EntityGroupEntity>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<EntityGroupEntity>();
