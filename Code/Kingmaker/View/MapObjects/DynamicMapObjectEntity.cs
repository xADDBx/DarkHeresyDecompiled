...
[OwlPackOldName("Kingmaker.View.MapObjects.DynamicMapObjectView+EntityData")]
public class DynamicMapObjectEntity : MapObjectEntity, IHashable, IOwlPackable<DynamicMapObjectEntity>
{
	[JsonProperty]
	[OwlPackInclude]
	...
	{
		Name = "DynamicMapObjectEntity",
		OldNames = new string[1] { "Kingmaker.View.MapObjects.DynamicMapObjectView+EntityData" },
		Fields = new FieldInfo[19]
		{
			...
			new FieldInfo("m_SavedOrientation", typeof(float))
		}
	};

	public new BlueprintDynamicMapObject OriginalBlueprint => (BlueprintDynamicMapObject)base.OriginalBlueprint;

	public new BlueprintDynamicMapObject Blueprint => (BlueprintDynamicMapObject)base.Blueprint;

	public DynamicMapObjectEntity(IMapObjectEntityConfig config)
		: base(config)
	{
	}

	public DynamicMapObjectEntity(OwlPackConstructorParameter _)
		: base(_)
	{
	}
	...
	protected override void OnSetConfig(IEntityConfig config)
	{
		...
		m_SavedPosition = config.Position;
		m_SavedOrientation = config.Orientation;
	}
	...
	{
		DynamicMapObjectEntity source = new DynamicMapObjectEntity(default(OwlPackConstructorParameter));
		result = Unsafe.As<DynamicMapObjectEntity, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<DynamicMapObjectEntity>(OwlPackTypeInfo);
		...
		formatter.UnmanagedField(18, "m_SavedOrientation", ref m_SavedOrientation, state);
		formatter.EndObject();
	}
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<DynamicMapObjectEntity>();
		...
		for (int i = 0; i < typeInfo.Fields.Length; i++)
		{
			...
			case 17:
				...
				break;
			case 18:
				m_SavedOrientation = formatter.ReadUnmanaged<float>(state);
				break;
			}
		}
