...
public class DetailedTrapObjectView : TrapObjectView, IBlueprintedMapObjectView
{
	...
	public override void ApplyBlueprint(BlueprintMapObject blueprint)
	{
		...
		awarenessCheckComponent.Settings.CustomDifficulty = Blueprint.AwarenessDC;
		awarenessCheckComponent.Settings.Difficulty = Blueprint.AwarenessDifficulty;
		awarenessCheckComponent.Settings.Radius = Blueprint.AwarenessRadius;
	}
