...
public static class InteractionHelper
{
	...
	{
		Game.Instance.PartySharedInventory.Collection.Add(ConfigRoot.Instance.Consumables.MeltaChargeItem, count);
	}
	...
	public static void AddItem([NotNull] string blueprintName, int count = 1)
	{
		...
		{
			Game.Instance.PartySharedInventory.Collection.Add(blueprint, count);
		}
	}
	...
	public static InteractionActorType ToInteractionActorType(this StatType statType)
	{
		...
		{
			StatType.SkillTechUse => InteractionActorType.TechUse, 
			StatType.SkillLoreXenos => InteractionActorType.LoreXenos, 
			_ => throw new NotImplementedException(), 
		};
	}

	public static int? GetUnitsToInteractCount(AbstractInteractionPart part)
	{
		if (part == null)
		{
			return null;
	...
	public static void MarkUnitAsInteracted(BaseUnitEntity unit, AbstractInteractionPart part)
	{
