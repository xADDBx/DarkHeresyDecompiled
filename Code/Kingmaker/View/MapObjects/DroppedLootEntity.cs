...
[OwlPackOldName("Kingmaker.View.MapObjects.DroppedLoot+EntityData")]
public class DroppedLootEntity : MapObjectEntity, IHashable, IOwlPackable<DroppedLootEntity>
{
	[JsonProperty]
	[OwlPackInclude]
	...
	{
		Name = "DroppedLootEntity",
		OldNames = new string[1] { "Kingmaker.View.MapObjects.DroppedLoot+EntityData" },
	...
	public DroppedLootEntity(IMapObjectEntityConfig config)
		: base(config)
	{
	}

	public DroppedLootEntity(OwlPackConstructorParameter _)
		: base(_)
	{
	}
	...
	{
		DroppedLootEntity source = new DroppedLootEntity(default(OwlPackConstructorParameter));
		result = Unsafe.As<DroppedLootEntity, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<DroppedLootEntity>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<DroppedLootEntity>();
