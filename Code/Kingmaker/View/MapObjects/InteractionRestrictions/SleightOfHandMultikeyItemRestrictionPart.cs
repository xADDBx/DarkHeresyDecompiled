...
public class SleightOfHandMultikeyItemRestrictionPart : SkillUseRestrictionPart<SleightOfHandMultikeyItemRestrictionSettings>, IHashable, IOwlPackable<SleightOfHandMultikeyItemRestrictionPart>
{
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<SleightOfHandMultikeyItemRestrictionPart>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<SleightOfHandMultikeyItemRestrictionPart>();
