...
public class MeltaChargeRestrictionPart : NeedItemRestrictionPart<MeltaChargeRestrictionSettings>, IHashable, IOwlPackable<MeltaChargeRestrictionPart>
{
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<MeltaChargeRestrictionPart>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<MeltaChargeRestrictionPart>();
