...
public abstract class InteractionRestrictionPart : EntityPartWithConfig, IInteractionRestriction, IHashable, IOwlPackable<InteractionRestrictionPart>
{
	[JsonProperty(DefaultValueHandling = DefaultValueHandling.Ignore)]
	[OwlPackInclude]
	public bool IsDisabled;

	public virtual LocalizedString RestrictedBark { get; }

	public virtual LocalizedString AllowedBark { get; }
	...
	{
		LocalizedString localizedString = (restricted ? RestrictedBark : AllowedBark);
