...
public class CameraZoom : MonoBehaviour
{
	...
	public void TickZoom()
	{
		...
		if (Game.Instance.CurrentModeType == GameModeType.SpaceCombat && !m_VirtualCamera)
		{
		...
		if (Game.Instance.CurrentModeType == GameModeType.SpaceCombat && (bool)m_VirtualCamera)
		{
	...
	{
		m_PlayerScrollPosition = (m_ScrollPosition = (m_SmoothScrollPosition = zoomTo));
		m_Camera.fieldOfView = Mathf.Lerp(FovMax, FovMin, CurrentNormalizePosition);
	}
}
