...
public class FxProjectileLauncher : MonoBehaviour
{
	...
	private static TimeSpan CurrentTime => Game.Instance.Controllers.TimeController.GameTime;

	private void OnEnable()
	{
		TimeSpan targetTime = CurrentTime + TimeSpan.FromSeconds(m_Delay);
		m_Coroutine = Game.Instance.Controllers.CoroutinesController.Start(Launch(targetTime), this);
	}
