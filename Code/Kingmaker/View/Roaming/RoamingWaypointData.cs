...
public class RoamingWaypointData : SimpleEntity, IRoamingPoint, IOwlPackable, IOwlPackable<IRoamingPoint>, IHashable, IOwlPackable<RoamingWaypointData>
{
	...
	BlueprintCutscene IRoamingPoint.SelectCutscene(StatefulRandom random)
	{
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<RoamingWaypointData>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<RoamingWaypointData>();
