...
public sealed class CharGenSetScarGameCommand : GameCommand, IMemoryPackable<CharGenSetScarGameCommand>, IMemoryPackFormatterRegister, IOwlPackable<CharGenSetScarGameCommand>
{
	[Preserve]
	private sealed class CharGenSetScarGameCommandFormatter : MemoryPackFormatter<CharGenSetScarGameCommand>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref CharGenSetScarGameCommand value)
		{
			CharGenSetScarGameCommand.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref CharGenSetScarGameCommand value)
		{
			CharGenSetScarGameCommand.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref CharGenSetScarGameCommand value)
		{
			CharGenSetScarGameCommand.DeserializeJson(ref reader, ref value);
		}
	}
	...
	private CharGenSetScarGameCommand(OwlPackConstructorParameter _)
	{
	}
	...
	static CharGenSetScarGameCommand()
	{
		...
		{
			Name = "CharGenSetScarGameCommand",
			OldNames = null,
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref CharGenSetScarGameCommand? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref CharGenSetScarGameCommand? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref CharGenSetScarGameCommand? value)
	{
		...
		_ = value;
		value = new CharGenSetScarGameCommand(val, v);
	...
	{
		CharGenSetScarGameCommand source = new CharGenSetScarGameCommand(default(OwlPackConstructorParameter));
		result = Unsafe.As<CharGenSetScarGameCommand, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<CharGenSetScarGameCommand>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<CharGenSetScarGameCommand>();
