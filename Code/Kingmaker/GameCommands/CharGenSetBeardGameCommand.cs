...
public sealed class CharGenSetBeardGameCommand : GameCommand, IMemoryPackable<CharGenSetBeardGameCommand>, IMemoryPackFormatterRegister, IOwlPackable<CharGenSetBeardGameCommand>
{
	[Preserve]
	private sealed class CharGenSetBeardGameCommandFormatter : MemoryPackFormatter<CharGenSetBeardGameCommand>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref CharGenSetBeardGameCommand value)
		{
			CharGenSetBeardGameCommand.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref CharGenSetBeardGameCommand value)
		{
			CharGenSetBeardGameCommand.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref CharGenSetBeardGameCommand value)
		{
			CharGenSetBeardGameCommand.DeserializeJson(ref reader, ref value);
		}
	}
	...
	private CharGenSetBeardGameCommand(OwlPackConstructorParameter _)
	{
	}
	...
	static CharGenSetBeardGameCommand()
	{
		...
		{
			Name = "CharGenSetBeardGameCommand",
			OldNames = null,
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref CharGenSetBeardGameCommand? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref CharGenSetBeardGameCommand? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref CharGenSetBeardGameCommand? value)
	{
		...
		_ = value;
		value = new CharGenSetBeardGameCommand(val, v);
	...
	{
		CharGenSetBeardGameCommand source = new CharGenSetBeardGameCommand(default(OwlPackConstructorParameter));
		result = Unsafe.As<CharGenSetBeardGameCommand, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<CharGenSetBeardGameCommand>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<CharGenSetBeardGameCommand>();
