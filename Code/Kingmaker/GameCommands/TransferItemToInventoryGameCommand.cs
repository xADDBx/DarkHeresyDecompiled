...
public class TransferItemToInventoryGameCommand : GameCommand, IOwlPackable<TransferItemToInventoryGameCommand>
{
	...
	{
		TransferItemToInventoryGameCommand source = new TransferItemToInventoryGameCommand();
		result = Unsafe.As<TransferItemToInventoryGameCommand, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<TransferItemToInventoryGameCommand>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<TransferItemToInventoryGameCommand>();
