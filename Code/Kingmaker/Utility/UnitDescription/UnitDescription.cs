...
public class UnitDescription
{
	...
	public class AttackData
	{
		...
		[JsonProperty]
		public DamageSettings[] Damage = new DamageSettings[0];
	...
	public class SavesData
	{
		...
		public string FortStringValue => UtilityText.AddSign(Fort);

		public string RefStringValue => UtilityText.AddSign(Ref);

		public string WillStringValue => UtilityText.AddSign(Will);
	}
