...
public class EnumArray<TValue>
{
	...
	public TValue GetValue<TEnum>(TEnum enumIndex) where TEnum : System.Enum
	{
		IOrderedEnumerable<TEnum> orderedEnumerable = (System.Enum.GetValues(typeof(TEnum)) as IEnumerable<TEnum>).OrderBy((TEnum e) => Convert.ToInt32(e));
		int num = 0;
