...
public class PlatformObjectEntity : Entity, IUpdatable, IHashable, IOwlPackable<PlatformObjectEntity>
{
	private Dictionary<MechanicEntity, Delta> m_EntitiesOnPlatform = new Dictionary<MechanicEntity, Delta>();

	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		Name = "PlatformObjectEntity",
		OldNames = null,
	...
	void IUpdatable.Tick(float delta)
	{
		...
		{
			if (mechanicEntity2.GetOptional<EntityPartStayOnPlatform>() != null)
			{
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<PlatformObjectEntity>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<PlatformObjectEntity>();
