...
public class RefreshSettingsPreset : PlayerUpgraderOnlyAction
{
	protected override void RunActionOverride()
	{
		...
		if (currentDifficulty != GameDifficultyOption.Custom && ConfigRoot.Instance.SettingsValues.DifficultiesPresets.Difficulties.TryFind((DifficultyPresetAsset x) => x.Preset.GameDifficulty == currentDifficulty, out var result))
		{
