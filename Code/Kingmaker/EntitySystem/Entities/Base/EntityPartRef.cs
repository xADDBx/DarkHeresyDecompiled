...
public struct EntityPartRef<TEntity, TPart> : IEquatable<EntityPartRef<TEntity, TPart>>, IHashable, IOwlPackable, IOwlPackable<EntityPartRef<TEntity, TPart>> where TEntity : Entity where TPart : EntityPart<TEntity>, new()
{
	[JsonProperty]
	[OwlPackInclude]
