...
public class MechanicLightRoot : MechanicEntity, IHashable, IOwlPackable<MechanicLightRoot>
{
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		Name = "MechanicLightRoot",
		OldNames = null,
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<MechanicLightRoot>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<MechanicLightRoot>();
