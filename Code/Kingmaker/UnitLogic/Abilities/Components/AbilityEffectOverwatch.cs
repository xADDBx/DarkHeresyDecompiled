...
public class AbilityEffectOverwatch : AbilityApplyEffect
{
	...
	public static HashSet<GridNodeBase> GetOverwatchArea(AbilityData overwatchAbility, TargetWrapper target)
	{
		...
		GridNodeBase casterNode = (GridNodeBase)(GraphNode)caster.CurrentNode;
		GridNodeBase nearestNodeXZUnwalkable = target.Point.GetNearestNodeXZUnwalkable();
		return patternSettings.GetOrientedPattern(overwatchAbility, casterNode, nearestNodeXZUnwalkable, caster.Size).Nodes.ToHashSet();
	}
}
