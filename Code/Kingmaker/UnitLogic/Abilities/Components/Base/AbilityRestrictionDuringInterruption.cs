...
public class AbilityRestrictionDuringInterruption : BlueprintComponent, IAbilityRestriction
{
	...
	{
		return UseOnlyDuringInterruption ? ConfigRoot.Instance.LocalizedTexts.Reasons.CanUseAbilityOnlyDuringInterruptingTurn : ConfigRoot.Instance.LocalizedTexts.Reasons.CannotUseAbilityDuringInterruptingTurn;
	}
}
