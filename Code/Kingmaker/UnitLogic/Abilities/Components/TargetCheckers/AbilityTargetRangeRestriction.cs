...
public class AbilityTargetRangeRestriction : BlueprintComponent, IAbilityTargetRestriction
{
	...
	{
		return (CompareType == CompareOperation.Type.Greater || CompareType == CompareOperation.Type.GreaterOrEqual) ? ConfigRoot.Instance.LocalizedTexts.Reasons.TargetIsTooClose : ConfigRoot.Instance.LocalizedTexts.Reasons.TargetIsTooFar;
	}
}
