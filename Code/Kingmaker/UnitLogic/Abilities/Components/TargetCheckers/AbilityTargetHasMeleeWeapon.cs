...
[ComponentName("Target Restriction/AbilityTargetHasMeleeWeapon")]
...
public class AbilityTargetHasMeleeWeapon : BlueprintComponent, IAbilityTargetRestriction
{
	...
	{
		return Not ? ConfigRoot.Instance.LocalizedTexts.Reasons.TargetHasNoMeleeWeapon : ConfigRoot.Instance.LocalizedTexts.Reasons.TargetHasMeleeWeapon;
	}
}
