...
[ComponentName("Target Restriction/AbilityTargetIsAlly")]
...
public class AbilityTargetIsAlly : BlueprintComponent, IAbilityTargetRestriction
{
	...
	{
		return Not ? ConfigRoot.Instance.LocalizedTexts.Reasons.TargetIsEnemy : ConfigRoot.Instance.LocalizedTexts.Reasons.TargetIsAlly;
	}
}
