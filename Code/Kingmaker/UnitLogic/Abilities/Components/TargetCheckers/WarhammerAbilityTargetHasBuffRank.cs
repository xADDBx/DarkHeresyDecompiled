...
[ComponentName("Target Restriction/WarhammerAbilityTargetHasBuffRank")]
...
public class WarhammerAbilityTargetHasBuffRank : BlueprintComponent, IAbilityTargetRestriction
{
	...
	{
		return (Not ? ConfigRoot.Instance.LocalizedTexts.Reasons.TargetHasNoConditionAndBuff : ConfigRoot.Instance.LocalizedTexts.Reasons.TargetHasConditionOrBuff).ToString(delegate
		{
