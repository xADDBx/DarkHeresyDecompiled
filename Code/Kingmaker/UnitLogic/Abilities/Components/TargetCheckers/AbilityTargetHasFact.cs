...
[ComponentName("Target Restriction/AbilityTargetHasFact")]
...
public class AbilityTargetHasFact : BlueprintComponent, IAbilityTargetRestriction
{
	...
	public string GetAbilityTargetRestrictionUIText(AbilityData ability, TargetWrapper target, Vector3 casterPosition)
	{
		...
		return (Inverted ? ConfigRoot.Instance.LocalizedTexts.Reasons.TargetHasNoFact : ConfigRoot.Instance.LocalizedTexts.Reasons.TargetHasFact).ToString(delegate
		{
