...
public class UnitVisualSettings
{
	...
	public MusicCombatState CombatMusic = MusicCombatState.Regular;

	[Space(10f)]
	public float DollRoomCameraFovOverride;

	public float DollRoomCameraYposOverride;
	...
	public GameObject GetBloodPuddle(SurfaceType bloodType)
	{
		...
		return ConfigRoot.Instance.HitSystemRoot.GetBloodPuddle(bloodType);
	}
	...
	public GameObject GetDismember(SurfaceType surfaceType, UnitDismemberType dismemberType)
	{
		...
		return ConfigRoot.Instance.HitSystemRoot.GetDismember(surfaceType, dismemberType);
	}
}
