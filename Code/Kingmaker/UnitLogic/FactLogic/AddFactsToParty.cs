...
[ComponentName("Facts And Buffs/AddFactsToParty")]
[TypeId("c0692276882a413b95b13da9c5ffdf23")]
public class AddFactsToParty : MechanicEntityFactComponentDelegate, IAreaHandler, ISubscriber, ICompanionStateChanged<EntitySubscriber>, ICompanionStateChanged, ISubscriber<IMechanicEntity>, IEventTag<ICompanionStateChanged, EntitySubscriber>, IAcceptChangeGroupHandler
{
	...
	private void AddFactsIfRestrictionPassed(MechanicEntity entity)
	{
		...
		{
			if (!entity.Facts.Contains(fact) && Restriction.IsPassed(base.Context, entity))
			{
