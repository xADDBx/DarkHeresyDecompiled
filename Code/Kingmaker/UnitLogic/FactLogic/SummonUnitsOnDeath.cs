...
[Serializable]
[ComponentName("Summon/SummonUnitsOnDeath")]
[TypeId("4676b57b7542493c80f1c2e7a1e6facf")]
public class SummonUnitsOnDeath : UnitFactComponentDelegate, IUnitDieHandler<EntitySubscriber>, IUnitDieHandler, ISubscriber<IAbstractUnitEntity>, ISubscriber, IEventTag<IUnitDieHandler, EntitySubscriber>
{
	[SerializeField]
	...
	{
		BaseUnitEntity baseUnitEntity = Game.Instance.Controllers.EntitySpawner.SpawnUnit(blueprint, base.Owner.Position, Quaternion.Euler(0f, base.Owner.Orientation, 0f), base.Owner.HoldingState);
		...
		{
			baseUnitEntity.GetOrCreate<PartEncounter>().Join(blueprintEncounter);
		}
