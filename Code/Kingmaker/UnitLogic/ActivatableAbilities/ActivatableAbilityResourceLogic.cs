...
public class ActivatableAbilityResourceLogic : UnitFactComponentDelegate, IActivatableAbilitySpendResourceLogic
{
	[Obsolete]
	...
	public bool IsAvailable(EntityFactComponent runtime)
	{
		using (runtime.SetScope())
		{
			...
			{
				return base.Owner.CombatState.ActionPoints >= ActionPointCost;
			}
