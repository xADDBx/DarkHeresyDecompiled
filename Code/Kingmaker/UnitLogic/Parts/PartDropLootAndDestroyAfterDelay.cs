...
public class PartDropLootAndDestroyAfterDelay : UnitPart, IGameTimeChangedHandler, ISubscriber, IHashable, IOwlPackable<PartDropLootAndDestroyAfterDelay>
{
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		Name = "PartDropLootAndDestroyAfterDelay",
		OldNames = null,
	...
	{
		PartDropLootAndDestroyAfterDelay source = new PartDropLootAndDestroyAfterDelay();
		result = Unsafe.As<PartDropLootAndDestroyAfterDelay, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<PartDropLootAndDestroyAfterDelay>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<PartDropLootAndDestroyAfterDelay>();
