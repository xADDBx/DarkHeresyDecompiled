...
public static class UnitPartCultAmbushExtension
{
	...
	{
		return (ability.Owner?.GetOptional<UnitPartCultAmbush>())?.Visibility(ability, isFirstShow) ?? UnitPartCultAmbush.VisibilityStatuses.Visible;
	}
	...
	{
		return (feature.Owner?.GetOptional<UnitPartCultAmbush>())?.Visibility(feature, isFirstShow) ?? UnitPartCultAmbush.VisibilityStatuses.Visible;
	}
