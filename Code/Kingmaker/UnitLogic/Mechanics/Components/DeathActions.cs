...
public class DeathActions : UnitFactComponentDelegate, IUnitHandler<EntitySubscriber>, IUnitHandler, IUnitSpawnHandler, ISubscriber<IAbstractUnitEntity>, ISubscriber, IEventTag<IUnitHandler, EntitySubscriber>
{
