...
public class ContextRestoreResource : ContextAction
{
	...
	{
		MechanicEntity mechanicEntity = ((!RestoreToSummonerUnit) ? base.Context.ClickedTarget?.Entity : base.Context.ClickedTarget?.Entity?.GetOptional<UnitPartSummonedMonster>()?.Summoner);
