...
public class MechanicEntityFactBlueprinted : MechanicEntityFact, IHashable, IOwlPackable<MechanicEntityFactBlueprinted>
{
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		Name = "MechanicEntityFactBlueprinted",
		OldNames = null,
	...
	public MechanicEntityFactBlueprinted()
	{
	}
	...
	{
		MechanicEntityFactBlueprinted source = new MechanicEntityFactBlueprinted();
		result = Unsafe.As<MechanicEntityFactBlueprinted, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<MechanicEntityFactBlueprinted>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<MechanicEntityFactBlueprinted>();
