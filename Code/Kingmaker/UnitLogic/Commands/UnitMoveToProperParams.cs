...
public sealed class UnitMoveToProperParams : UnitCommandParams<UnitMoveToProper>, IMemoryPackable<UnitMoveToProperParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitMoveToProperParams>
{
	[Preserve]
	private sealed class UnitMoveToProperParamsFormatter : MemoryPackFormatter<UnitMoveToProperParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitMoveToProperParams value)
		{
			UnitMoveToProperParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitMoveToProperParams value)
		{
			UnitMoveToProperParams.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitMoveToProperParams value)
		{
			UnitMoveToProperParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitMoveToProperParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitMoveToProperParams? value)
	{
		...
		if (memberCount == 21)
		{
			if (value == null)
			{
				...
				value17 = reader.ReadPackable<CountableFlag>();
				reader.ReadUnmanaged<float, int>(out value18, out value19);
				value20 = reader.ReadUnmanagedArray<float>();
				reader.ReadUnmanaged<int, int>(out value21, out value22);
			}
			else
			{
				value2 = value.Type;
				...
				value17 = value.DisableAttackOfOpportunity;
				value18 = value.ActionPointsPerCell;
				value19 = value.ActionPointsToSpend;
				value20 = value.ApCostPerEveryCell;
				value21 = value.StraightMoveLength;
				value22 = value.DiagonalsCount;
				reader.ReadUnmanaged<CommandType>(out value2);
				...
				reader.ReadUnmanaged<float>(out value18);
				reader.ReadUnmanaged<int>(out value19);
				reader.ReadUnmanagedArray(ref value20);
		...
		value = new UnitMoveToProperParams(value17, value18, value19, value20, value21, value22)
		{
			Type = value2,
			OwnerRef = value3,
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitMoveToProperParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
		...
		writer.WriteProperty("DisableAttackOfOpportunity");
		writer.WritePackable(value.DisableAttackOfOpportunity);
		writer.WriteProperty("ActionPointsPerCell");
		writer.WriteUnmanaged(value.ActionPointsPerCell);
		writer.WriteProperty("ActionPointsToSpend");
		writer.WriteUnmanaged(value.ActionPointsToSpend);
		writer.WriteProperty("ApCostPerEveryCell");
		writer.WriteArray(value.ApCostPerEveryCell);
		writer.WriteProperty("StraightMoveLength");
		writer.WriteUnmanaged(value.StraightMoveLength);
		writer.WriteProperty("DiagonalsCount");
		writer.WriteUnmanaged(value.DiagonalsCount);
		writer.WriteObjectFooter();
	}

	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitMoveToProperParams? value)
	{
		...
		else
		{
			...
			val4 = value.DisableAttackOfOpportunity;
			v13 = value.ActionPointsPerCell;
			v14 = value.ActionPointsToSpend;
			value2 = value.ApCostPerEveryCell;
			v15 = value.StraightMoveLength;
			v16 = value.DiagonalsCount;
		}
		bool[] array = new bool[21];
		string text = null;
		while ((text = reader.ReadPropertyName()) != null)
		{
			if (value == null)
			{
				...
				case "m_SlowMotionRequired":
					...
					array[14] = true;
					break;
				case "DisableAttackOfOpportunity":
					val4 = reader.ReadPackable<CountableFlag>();
					array[15] = true;
					break;
				case "ActionPointsPerCell":
					reader.ReadUnmanaged<float>(out v13);
					array[16] = true;
					break;
				case "ActionPointsToSpend":
					reader.ReadUnmanaged<int>(out v14);
					array[17] = true;
					break;
				case "ApCostPerEveryCell":
					value2 = reader.ReadArray<float>();
					array[18] = true;
					break;
				case "StraightMoveLength":
					reader.ReadUnmanaged<int>(out v15);
					array[19] = true;
					break;
				case "DiagonalsCount":
					reader.ReadUnmanaged<int>(out v16);
					array[20] = true;
					break;
				}
			}
		...
		_ = value;
		value = new UnitMoveToProperParams(val4, v13, v14, value2, v15, v16)
		{
			Type = v,
			OwnerRef = val,
	...
	{
		UnitMoveToProperParams source = new UnitMoveToProperParams();
		result = Unsafe.As<UnitMoveToProperParams, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitMoveToProperParams>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitMoveToProperParams>();
