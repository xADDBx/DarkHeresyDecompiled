...
public sealed class UnitJumpAsideDodgeParams : UnitCommandParams<UnitJumpAsideDodge>, IMemoryPackable<UnitJumpAsideDodgeParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitJumpAsideDodgeParams>
{
	[Preserve]
	private sealed class UnitJumpAsideDodgeParamsFormatter : MemoryPackFormatter<UnitJumpAsideDodgeParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitJumpAsideDodgeParams value)
		{
			UnitJumpAsideDodgeParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitJumpAsideDodgeParams value)
		{
			UnitJumpAsideDodgeParams.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitJumpAsideDodgeParams value)
		{
			UnitJumpAsideDodgeParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitJumpAsideDodgeParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitJumpAsideDodgeParams? value)
	{
		...
		else
		{
			if (memberCount > 15)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitJumpAsideDodgeParams), 15, memberCount);
				return;
			}
			if (value == null)
			{
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitJumpAsideDodgeParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitJumpAsideDodgeParams? value)
	{
	...
	{
		UnitJumpAsideDodgeParams source = new UnitJumpAsideDodgeParams();
		result = Unsafe.As<UnitJumpAsideDodgeParams, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitJumpAsideDodgeParams>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitJumpAsideDodgeParams>();
