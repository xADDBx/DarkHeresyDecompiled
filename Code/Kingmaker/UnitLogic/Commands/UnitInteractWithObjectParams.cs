...
public sealed class UnitInteractWithObjectParams : UnitCommandParams<UnitInteractWithObject>, IOwlPackable<UnitInteractWithObjectParams>
{
	[JsonProperty]
	[OwlPackInclude]
	...
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		...
		Fields = new FieldInfo[16]
		{
			...
			new FieldInfo("m_VariantActor", typeof(ViewBasedPartRef<MapObjectEntity, ViewBasedPart>))
		}
	};
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		formatter.Field(15, "m_VariantActor", ref m_VariantActor, state);
		formatter.EndObject();
	}
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		for (int i = 0; i < typeInfo.Fields.Length; i++)
		{
			...
			case 14:
				...
				break;
			case 15:
				m_VariantActor = formatter.ReadPackable<ViewBasedPartRef<MapObjectEntity, ViewBasedPart>>(state);
				break;
			}
		}
