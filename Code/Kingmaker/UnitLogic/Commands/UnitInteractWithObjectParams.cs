...
public sealed class UnitInteractWithObjectParams : UnitCommandParams<UnitInteractWithObject>, IMemoryPackable<UnitInteractWithObjectParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitInteractWithObjectParams>
{
	[Preserve]
	private sealed class UnitInteractWithObjectParamsFormatter : MemoryPackFormatter<UnitInteractWithObjectParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitInteractWithObjectParams value)
		{
			UnitInteractWithObjectParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitInteractWithObjectParams value)
		{
			UnitInteractWithObjectParams.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitInteractWithObjectParams value)
		{
			UnitInteractWithObjectParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[OwlPackInclude]
	[MemoryPackInclude]
	private EntityPartAbstractRef<MapObjectEntity, AbstractInteractionPart> m_Interaction;

	[JsonProperty]
	[OwlPackInclude]
	[MemoryPackInclude]
	private EntityPartAbstractRef<MapObjectEntity, EntityPartWithConfig> m_VariantActor;

	public static readonly TypeInfo OwlPackTypeInfo;

	[MemoryPackIgnore]
	public AbstractInteractionPart Interaction => m_Interaction;

	[MemoryPackIgnore]
	public EntityPartWithConfig VariantActor => m_VariantActor;

	public override int DefaultApproachRadius => Interaction.ApproachRadius;
	...
	public UnitInteractWithObjectParams([NotNull] AbstractInteractionPart interaction, [CanBeNull] IInteractionVariantActor variantActor = null)
		: base((TargetWrapper)interaction.Owner)
	{
		...
		m_Interaction = new EntityPartAbstractRef<MapObjectEntity, AbstractInteractionPart>(interaction);
		if (variantActor == null)
		{
			variantActor = ContextData<InteractionVariantData>.Current?.VariantActor;
		}
		if (variantActor is EntityPartWithConfig part)
		{
			m_VariantActor = new EntityPartAbstractRef<MapObjectEntity, EntityPartWithConfig>(part);
		}
	}
	...
	static UnitInteractWithObjectParams()
	{
		...
		{
			Name = "UnitInteractWithObjectParams",
			OldNames = null,
			Fields = new FieldInfo[17]
			{
				...
				new FieldInfo("m_Interaction", typeof(EntityPartAbstractRef<MapObjectEntity, AbstractInteractionPart>)),
				new FieldInfo("m_VariantActor", typeof(EntityPartAbstractRef<MapObjectEntity, EntityPartWithConfig>))
			}
		};
		RegisterFormatter();
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitInteractWithObjectParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitInteractWithObjectParams? value)
	{
		...
		bool? value15;
		bool? value16;
		EntityPartAbstractRef<MapObjectEntity, AbstractInteractionPart> value17;
		EntityPartAbstractRef<MapObjectEntity, EntityPartWithConfig> value18;
		if (memberCount == 17)
		{
			if (value != null)
			{
				...
				value17 = value.m_Interaction;
				value18 = value.m_VariantActor;
			...
			value17 = reader.ReadPackable<EntityPartAbstractRef<MapObjectEntity, AbstractInteractionPart>>();
			value18 = reader.ReadPackable<EntityPartAbstractRef<MapObjectEntity, EntityPartWithConfig>>();
		}
		else
		{
			if (memberCount > 17)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitInteractWithObjectParams), 17, memberCount);
				return;
			}
			if (value == null)
			{
				...
				value15 = null;
				value16 = null;
				value17 = default(EntityPartAbstractRef<MapObjectEntity, AbstractInteractionPart>);
				value18 = default(EntityPartAbstractRef<MapObjectEntity, EntityPartWithConfig>);
			}
			else
			{
				value2 = value.Type;
		...
		value = new UnitInteractWithObjectParams
		{
			...
			m_Interaction = value17,
			m_VariantActor = value18
		};
		return;
		IL_03aa:
		value.Type = value2;
		...
		value.m_Interaction = value17;
		value.m_VariantActor = value18;
	}

	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitInteractWithObjectParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
		...
		writer.WriteProperty("m_Interaction");
		writer.WritePackable(value.m_Interaction);
		writer.WriteProperty("m_VariantActor");
		writer.WritePackable(value.m_VariantActor);
		writer.WriteObjectFooter();
	}

	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitInteractWithObjectParams? value)
	{
		...
		bool? v11;
		bool? v12;
		EntityPartAbstractRef<MapObjectEntity, AbstractInteractionPart> val4;
		EntityPartAbstractRef<MapObjectEntity, EntityPartWithConfig> val5;
		if (value == null)
		{
			v = CommandType.None;
			...
			v11 = null;
			v12 = null;
			val4 = default(EntityPartAbstractRef<MapObjectEntity, AbstractInteractionPart>);
			val5 = default(EntityPartAbstractRef<MapObjectEntity, EntityPartWithConfig>);
		}
		else
		{
			v = value.Type;
			...
			val4 = value.m_Interaction;
			val5 = value.m_VariantActor;
		}
		...
		while ((text = reader.ReadPropertyName()) != null)
		{
			if (value == null)
			{
				...
				case "m_SlowMotionRequired":
					...
					break;
				case "m_Interaction":
					val4 = reader.ReadPackable<EntityPartAbstractRef<MapObjectEntity, AbstractInteractionPart>>();
					array[15] = true;
					break;
				case "m_VariantActor":
					val5 = reader.ReadPackable<EntityPartAbstractRef<MapObjectEntity, EntityPartWithConfig>>();
					array[16] = true;
					break;
				}
			}
		...
		if (value != null)
		{
			...
			value.m_Interaction = val4;
			value.m_VariantActor = val5;
		}
		else
		{
			value = new UnitInteractWithObjectParams
	...
	{
		UnitInteractWithObjectParams source = new UnitInteractWithObjectParams();
		result = Unsafe.As<UnitInteractWithObjectParams, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitInteractWithObjectParams>(OwlPackTypeInfo);
		...
		formatter.Field(15, "m_Interaction", ref m_Interaction, state);
		formatter.Field(16, "m_VariantActor", ref m_VariantActor, state);
		formatter.EndObject();
	}
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitInteractWithObjectParams>();
		...
		for (int i = 0; i < typeInfo.Fields.Length; i++)
		{
			...
			case 14:
				...
				break;
			case 15:
				m_Interaction = formatter.ReadPackable<EntityPartAbstractRef<MapObjectEntity, AbstractInteractionPart>>(state);
				break;
			case 16:
				m_VariantActor = formatter.ReadPackable<EntityPartAbstractRef<MapObjectEntity, EntityPartWithConfig>>(state);
				break;
			}
		}
