...
public sealed class UnitLootUnitParams : UnitCommandParams<UnitLootUnit>, IMemoryPackable<UnitLootUnitParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitLootUnitParams>
{
	[Preserve]
	private sealed class UnitLootUnitParamsFormatter : MemoryPackFormatter<UnitLootUnitParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitLootUnitParams value)
		{
			UnitLootUnitParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitLootUnitParams value)
		{
			UnitLootUnitParams.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitLootUnitParams value)
		{
			UnitLootUnitParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitLootUnitParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitLootUnitParams? value)
	{
		...
		if (memberCount == 16)
		{
			if (value != null)
			{
				...
				value17 = value.OverrideApproachPoint;
				...
				reader.DangerousReadUnmanaged<Vector3?>(out value17);
				goto IL_036a;
			}
			reader.ReadUnmanaged<CommandType>(out value2);
			...
			reader.DangerousReadUnmanaged<WalkSpeedType?, bool?, bool?, Vector3?>(out value14, out value15, out value16, out value17);
		}
		else
		{
			if (memberCount > 16)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitLootUnitParams), 16, memberCount);
				return;
			}
			if (value == null)
			{
		...
		value.OverrideApproachPoint = value17;
	}

	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitLootUnitParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
		...
		writer.WriteProperty("OverrideApproachPoint");
		writer.DangerousWriteUnmanaged(value.OverrideApproachPoint);
		writer.WriteObjectFooter();
	}

	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitLootUnitParams? value)
	{
		...
		else
		{
			...
			v13 = value.OverrideApproachPoint;
		}
		...
		while ((text = reader.ReadPropertyName()) != null)
		{
			if (value == null)
			{
				...
				case "m_SlowMotionRequired":
					...
					array[14] = true;
					break;
				case "OverrideApproachPoint":
					reader.DangerousReadUnmanaged<Vector3?>(out v13);
					array[15] = true;
					break;
				}
			}
		...
		if (value != null)
		{
			...
			value.OverrideApproachPoint = v13;
		}
		else
		{
			value = new UnitLootUnitParams
