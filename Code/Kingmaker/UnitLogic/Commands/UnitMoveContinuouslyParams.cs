...
public sealed class UnitMoveContinuouslyParams : UnitCommandParams<UnitMoveContinuously>, IMemoryPackable<UnitMoveContinuouslyParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitMoveContinuouslyParams>
{
	[Preserve]
	private sealed class UnitMoveContinuouslyParamsFormatter : MemoryPackFormatter<UnitMoveContinuouslyParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitMoveContinuouslyParams value)
		{
			UnitMoveContinuouslyParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitMoveContinuouslyParams value)
		{
			UnitMoveContinuouslyParams.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitMoveContinuouslyParams value)
		{
			UnitMoveContinuouslyParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	static UnitMoveContinuouslyParams()
	{
		...
		{
			Name = "UnitMoveContinuouslyParams",
			OldNames = null,
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitMoveContinuouslyParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitMoveContinuouslyParams? value)
	{
		...
		if (memberCount == 17)
		{
			if (value != null)
			{
				...
				value17 = value.Direction;
				value18 = value.Multiplier;
				...
				reader.ReadUnmanaged<Vector2>(out value17);
			...
			reader.DangerousReadUnmanaged<WalkSpeedType?, bool?, bool?, Vector2, float>(out value14, out value15, out value16, out value17, out value18);
		}
		else
		{
			if (memberCount > 17)
		...
		value.Direction = value17;
		value.Multiplier = value18;
	}

	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitMoveContinuouslyParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
		...
		writer.WriteUnmanaged(value.Direction);
		writer.WriteProperty("Multiplier");
		writer.WriteUnmanaged(value.Multiplier);
		writer.WriteObjectFooter();
	}

	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitMoveContinuouslyParams? value)
	{
		...
		while ((text = reader.ReadPropertyName()) != null)
		{
			if (value == null)
			{
				...
				case "m_SlowMotionRequired":
					...
					break;
				case "Direction":
					reader.ReadUnmanaged<Vector2>(out v13);
					array[15] = true;
					break;
				case "Multiplier":
	...
	{
		UnitMoveContinuouslyParams source = new UnitMoveContinuouslyParams();
		result = Unsafe.As<UnitMoveContinuouslyParams, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitMoveContinuouslyParams>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitMoveContinuouslyParams>();
