...
public class UnitUseAbilityParams : UnitUseAbilityParamsAbstract<UnitUseAbility>, IMemoryPackable<UnitUseAbilityParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitUseAbilityParams>
{
	[Preserve]
	private sealed class UnitUseAbilityParamsFormatter : MemoryPackFormatter<UnitUseAbilityParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitUseAbilityParams value)
		{
			UnitUseAbilityParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitUseAbilityParams value)
		{
			UnitUseAbilityParams.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitUseAbilityParams value)
		{
			UnitUseAbilityParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitUseAbilityParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitUseAbilityParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitUseAbilityParams? value)
	{
