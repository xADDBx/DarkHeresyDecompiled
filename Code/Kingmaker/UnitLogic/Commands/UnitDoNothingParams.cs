...
public sealed class UnitDoNothingParams : UnitCommandParams<UnitDoNothing>, IOwlPackable<UnitDoNothingParams>
{
	[JsonProperty]
	[OwlPackInclude]
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		formatter.UnmanagedField(14, "DoNothingTime", ref DoNothingTime, state);
		formatter.EndObject();
	}
