...
public sealed class UnitDirectInteractParams : UnitCommandParams<UnitDirectInteract>, IMemoryPackable<UnitDirectInteractParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitDirectInteractParams>
{
	[Preserve]
	private sealed class UnitDirectInteractParamsFormatter : MemoryPackFormatter<UnitDirectInteractParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitDirectInteractParams value)
		{
			UnitDirectInteractParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitDirectInteractParams value)
		{
			UnitDirectInteractParams.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitDirectInteractParams value)
		{
			UnitDirectInteractParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitDirectInteractParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitDirectInteractParams? value)
	{
		...
		else
		{
			if (memberCount > 16)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitDirectInteractParams), 16, memberCount);
				return;
			}
			if (value == null)
			{
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitDirectInteractParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitDirectInteractParams? value)
	{
