...
public sealed class UnitActivateAbilityParams : UnitCommandParams<UnitActivateAbility>, IOwlPackable<UnitActivateAbilityParams>
{
	[JsonProperty]
	[OwlPackInclude]
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		formatter.Field(14, "m_Ability", ref value6, state);
		formatter.EndObject();
	}
