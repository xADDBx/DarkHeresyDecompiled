...
public sealed class UnitTeleportParams : UnitCommandParams<UnitTeleport>, IMemoryPackable<UnitTeleportParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitTeleportParams>
{
	[Preserve]
	private sealed class UnitTeleportParamsFormatter : MemoryPackFormatter<UnitTeleportParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitTeleportParams value)
		{
			UnitTeleportParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitTeleportParams value)
		{
			UnitTeleportParams.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitTeleportParams value)
		{
			UnitTeleportParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitTeleportParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitTeleportParams? value)
	{
		...
		value = new UnitTeleportParams(value17)
		{
			Type = value2,
			OwnerRef = value3,
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitTeleportParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitTeleportParams? value)
	{
		...
		_ = value;
		value = new UnitTeleportParams(v13)
		{
			Type = v,
			OwnerRef = val,
	...
	{
		UnitTeleportParams source = new UnitTeleportParams();
		result = Unsafe.As<UnitTeleportParams, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitTeleportParams>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitTeleportParams>();
