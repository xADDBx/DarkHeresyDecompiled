...
public sealed class UnitMoveAlongPathParams : UnitCommandParams<UnitMoveAlongPath>, IMemoryPackable<UnitMoveAlongPathParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitMoveAlongPathParams>
{
	[Preserve]
	private sealed class UnitMoveAlongPathParamsFormatter : MemoryPackFormatter<UnitMoveAlongPathParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitMoveAlongPathParams value)
		{
			UnitMoveAlongPathParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitMoveAlongPathParams value)
		{
			UnitMoveAlongPathParams.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitMoveAlongPathParams value)
		{
			UnitMoveAlongPathParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitMoveAlongPathParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitMoveAlongPathParams? value)
	{
		...
		else
		{
			if (memberCount > 15)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitMoveAlongPathParams), 15, memberCount);
				return;
			}
			if (value == null)
			{
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitMoveAlongPathParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitMoveAlongPathParams? value)
	{
	...
	{
		UnitMoveAlongPathParams source = new UnitMoveAlongPathParams();
		result = Unsafe.As<UnitMoveAlongPathParams, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitMoveAlongPathParams>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitMoveAlongPathParams>();
