...
public class UnitEndTurnParams : UnitCommandParams<UnitEndTurn>, IMemoryPackable<UnitEndTurnParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitEndTurnParams>
{
	[Preserve]
	private sealed class UnitEndTurnParamsFormatter : MemoryPackFormatter<UnitEndTurnParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitEndTurnParams value)
		{
			UnitEndTurnParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitEndTurnParams value)
		{
			UnitEndTurnParams.SerializeJson(ref writer, ref value);
		}

		[Preserve]
		public override void Deserialize(ref MemoryPackReader reader, ref UnitEndTurnParams value)
		{
			UnitEndTurnParams.Deserialize(ref reader, ref value);
		}

		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitEndTurnParams value)
		{
			UnitEndTurnParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	protected override bool DefaultIsOneFrameCommand => true;

	protected override bool DefaultNeedLoS => true;

	[JsonConstructor]
	[MemoryPackConstructor]
	public UnitEndTurnParams(TimeSpan delay = default(TimeSpan))
		: base(default(JsonConstructorMark))
	{
		Delay = delay;
	}

	private UnitEndTurnParams()
	{
	}

	static UnitEndTurnParams()
	{
		OwlPackTypeInfo = new TypeInfo
		{
			Name = "UnitEndTurnParams",
			OldNames = null,
			Fields = new FieldInfo[16]
			{
				...
				new FieldInfo("Delay", typeof(TimeSpan))
			}
		};
		RegisterFormatter();
	}
	...
	{
		if (!MemoryPackFormatterProvider.IsRegistered<UnitEndTurnParams>())
		{
			MemoryPackFormatterProvider.Register(new UnitEndTurnParamsFormatter());
		}
		if (!MemoryPackFormatterProvider.IsRegistered<UnitEndTurnParams[]>())
		{
			MemoryPackFormatterProvider.Register(new ArrayFormatter<UnitEndTurnParams>());
		}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitEndTurnParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
		...
		writer.DangerousWriteUnmanaged(in value.m_MovementType, in value.m_IsOneFrameCommand, in value.m_SlowMotionRequired, in value.Delay);
	}

	[Preserve]
	public static void Deserialize(ref MemoryPackReader reader, ref UnitEndTurnParams? value)
	{
		...
		if (memberCount == 16)
		{
			if (value == null)
			{
				...
				reader.DangerousReadUnmanaged<WalkSpeedType?, bool?, bool?, TimeSpan>(out value14, out value15, out value16, out value17);
			}
			else
			{
				value2 = value.Type;
				...
				reader.ReadUnmanaged<TimeSpan>(out value17);
			}
		}
		else
		{
			if (memberCount > 16)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitEndTurnParams), 16, memberCount);
				return;
			}
			if (value == null)
			{
		...
		value = new UnitEndTurnParams(value17)
		{
			Type = value2,
			OwnerRef = value3,
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitEndTurnParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
		...
		writer.WriteProperty("Delay");
		writer.WriteUnmanaged(value.Delay);
		writer.WriteObjectFooter();
	}

	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitEndTurnParams? value)
	{
		...
		while ((text = reader.ReadPropertyName()) != null)
		{
			if (value == null)
			{
				...
				case "m_SlowMotionRequired":
					...
					break;
				case "Delay":
					reader.ReadUnmanaged<TimeSpan>(out v13);
					array[15] = true;
					break;
				}
			}
		...
		_ = value;
		value = new UnitEndTurnParams(v13)
		{
			Type = v,
			OwnerRef = val,
	...
	{
		UnitEndTurnParams source = new UnitEndTurnParams();
		result = Unsafe.As<UnitEndTurnParams, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitEndTurnParams>(OwlPackTypeInfo);
		...
		TimeSpan value6 = Delay;
		formatter.Field(15, "Delay", ref value6, state);
		formatter.EndObject();
	}
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitEndTurnParams>();
		...
		for (int i = 0; i < typeInfo.Fields.Length; i++)
		{
			...
			case 14:
				...
				break;
			case 15:
				Unsafe.AsRef(in Delay) = formatter.ReadPackable<TimeSpan>(state);
				break;
			}
		}
