...
public sealed class UnitToggleAbilityParams : UnitCommandParams<UnitToggleAbility>, IMemoryPackable<UnitToggleAbilityParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitToggleAbilityParams>
{
	[Preserve]
	private sealed class UnitToggleAbilityParamsFormatter : MemoryPackFormatter<UnitToggleAbilityParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitToggleAbilityParams value)
		{
			UnitToggleAbilityParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitToggleAbilityParams value)
		{
			UnitToggleAbilityParams.SerializeJson(ref writer, ref value);
		}

		[Preserve]
		public override void Deserialize(ref MemoryPackReader reader, ref UnitToggleAbilityParams value)
		{
			UnitToggleAbilityParams.Deserialize(ref reader, ref value);
		}

		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitToggleAbilityParams value)
		{
			UnitToggleAbilityParams.DeserializeJson(ref reader, ref value);
		}
	}

	[JsonProperty(PropertyName = "bp_ref")]
	[OwlPackInclude]
	[MemoryPackInclude]
	private BlueprintToggleAbilityReference m_BlueprintRef;

	public static readonly TypeInfo OwlPackTypeInfo;

	[MemoryPackIgnore]
	public BlueprintToggleAbility Blueprint => m_BlueprintRef.Blueprint;

	[JsonConstructor]
	[MemoryPackConstructor]
	public UnitToggleAbilityParams()
		: base(default(JsonConstructorMark))
	{
	}

	public UnitToggleAbilityParams(BlueprintToggleAbility blueprint)
	{
		m_BlueprintRef = blueprint.ToReference<BlueprintToggleAbilityReference>();
	}

	static UnitToggleAbilityParams()
	{
		OwlPackTypeInfo = new TypeInfo
		{
			Name = "UnitToggleAbilityParams",
			OldNames = null,
			Fields = new FieldInfo[16]
			{
				...
				new FieldInfo("m_BlueprintRef", typeof(BlueprintToggleAbilityReference))
			}
		};
		RegisterFormatter();
	}
	...
	{
		if (!MemoryPackFormatterProvider.IsRegistered<UnitToggleAbilityParams>())
		{
			MemoryPackFormatterProvider.Register(new UnitToggleAbilityParamsFormatter());
		}
		if (!MemoryPackFormatterProvider.IsRegistered<UnitToggleAbilityParams[]>())
		{
			MemoryPackFormatterProvider.Register(new ArrayFormatter<UnitToggleAbilityParams>());
		}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitToggleAbilityParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
		...
		writer.WritePackable(in value.m_BlueprintRef);
	}

	[Preserve]
	public static void Deserialize(ref MemoryPackReader reader, ref UnitToggleAbilityParams? value)
	{
		...
		bool? value15;
		bool? value16;
		BlueprintToggleAbilityReference value17;
		if (memberCount == 16)
		{
			if (value != null)
			{
			...
			value17 = reader.ReadPackable<BlueprintToggleAbilityReference>();
		}
		else
		{
			if (memberCount > 16)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitToggleAbilityParams), 16, memberCount);
				return;
			}
			if (value == null)
			{
		...
		value = new UnitToggleAbilityParams
		{
			Type = value2,
			OwnerRef = value3,
		...
		value.m_BlueprintRef = value17;
	}

	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitToggleAbilityParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
		...
		writer.WriteProperty("m_BlueprintRef");
		writer.WritePackable(value.m_BlueprintRef);
		writer.WriteObjectFooter();
	}

	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitToggleAbilityParams? value)
	{
		...
		bool? v11;
		bool? v12;
		BlueprintToggleAbilityReference val4;
		if (value == null)
		{
			v = CommandType.None;
		...
		while ((text = reader.ReadPropertyName()) != null)
		{
			if (value == null)
			{
				...
				case "m_SlowMotionRequired":
					...
					break;
				case "m_BlueprintRef":
					val4 = reader.ReadPackable<BlueprintToggleAbilityReference>();
					array[15] = true;
					break;
				}
			}
	...
	{
		UnitToggleAbilityParams source = new UnitToggleAbilityParams();
		result = Unsafe.As<UnitToggleAbilityParams, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitToggleAbilityParams>(OwlPackTypeInfo);
		...
		formatter.Field(15, "m_BlueprintRef", ref m_BlueprintRef, state);
		formatter.EndObject();
	}
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitToggleAbilityParams>();
		...
		for (int i = 0; i < typeInfo.Fields.Length; i++)
		{
			...
			case 14:
				...
				break;
			case 15:
				m_BlueprintRef = formatter.ReadPackable<BlueprintToggleAbilityReference>(state);
				break;
			}
		}
