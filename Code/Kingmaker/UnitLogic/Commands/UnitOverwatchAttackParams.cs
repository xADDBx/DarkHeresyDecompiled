...
public sealed class UnitOverwatchAttackParams : UnitUseAbilityParamsAbstract<UnitOverwatchAttack>, IMemoryPackable<UnitOverwatchAttackParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitOverwatchAttackParams>
{
	[Preserve]
	private sealed class UnitOverwatchAttackParamsFormatter : MemoryPackFormatter<UnitOverwatchAttackParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitOverwatchAttackParams value)
		{
			UnitOverwatchAttackParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitOverwatchAttackParams value)
		{
			UnitOverwatchAttackParams.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitOverwatchAttackParams value)
		{
			UnitOverwatchAttackParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	static UnitOverwatchAttackParams()
	{
		...
		{
			Name = "UnitOverwatchAttackParams",
			OldNames = null,
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitOverwatchAttackParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitOverwatchAttackParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
	...
	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitOverwatchAttackParams? value)
	{
	...
	{
		UnitOverwatchAttackParams source = new UnitOverwatchAttackParams();
		result = Unsafe.As<UnitOverwatchAttackParams, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitOverwatchAttackParams>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitOverwatchAttackParams>();
