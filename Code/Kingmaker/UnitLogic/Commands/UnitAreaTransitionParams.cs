...
public sealed class UnitAreaTransitionParams : UnitGroupCommandParams<UnitAreaTransition>, IMemoryPackable<UnitAreaTransitionParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitAreaTransitionParams>
{
	[Preserve]
	private sealed class UnitAreaTransitionParamsFormatter : MemoryPackFormatter<UnitAreaTransitionParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitAreaTransitionParams value)
		{
			UnitAreaTransitionParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitAreaTransitionParams value)
		{
			UnitAreaTransitionParams.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitAreaTransitionParams value)
		{
			UnitAreaTransitionParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitAreaTransitionParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
		...
		ListFormatter.SerializePackable(ref writer, value.Units);
	}
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitAreaTransitionParams? value)
	{
		...
		bool? value16;
		Guid value17;
		List<EntityRef<BaseUnitEntity>> value18;
		if (memberCount == 17)
		{
			if (value == null)
			{
				...
				reader.DangerousReadUnmanaged<WalkSpeedType?, bool?, bool?, Guid>(out value14, out value15, out value16, out value17);
				value18 = ListFormatter.DeserializePackable<EntityRef<BaseUnitEntity>>(ref reader);
			}
			else
			{
				value2 = value.Type;
				...
				reader.ReadUnmanaged<Guid>(out value17);
		...
		else
		{
			if (memberCount > 17)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitAreaTransitionParams), 17, memberCount);
				return;
			}
			if (value == null)
			{
		...
		value = new UnitAreaTransitionParams(value17, value18)
		{
			Type = value2,
			OwnerRef = value3,
	...
	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitAreaTransitionParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
		...
		writer.WriteProperty("GroupGuid");
		writer.WriteUnmanaged(value.GroupGuid);
		writer.WriteProperty("Units");
		ListFormatter.SerializePackableJson(ref writer, value.Units);
		writer.WriteObjectFooter();
	}

	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitAreaTransitionParams? value)
	{
		...
		bool? v12;
		Guid v13;
		List<EntityRef<BaseUnitEntity>> value2;
		if (value == null)
		{
			v = CommandType.None;
		...
		while ((text = reader.ReadPropertyName()) != null)
		{
			if (value == null)
			{
				...
				case "m_SlowMotionRequired":
					...
					break;
				case "GroupGuid":
					reader.ReadUnmanaged<Guid>(out v13);
					array[15] = true;
					break;
				case "Units":
					value2 = ListFormatter.DeserializePackableJson<EntityRef<BaseUnitEntity>>(ref reader);
					array[16] = true;
					break;
				}
			}
		...
		_ = value;
		value = new UnitAreaTransitionParams(v13, value2)
		{
			Type = v,
			OwnerRef = val,
	...
	{
		UnitAreaTransitionParams source = new UnitAreaTransitionParams();
		result = Unsafe.As<UnitAreaTransitionParams, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitAreaTransitionParams>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitAreaTransitionParams>();
