...
public sealed class UnitFollowParams : UnitCommandParams<UnitFollow>, IMemoryPackable<UnitFollowParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitFollowParams>
{
	[Preserve]
	private sealed class UnitFollowParamsFormatter : MemoryPackFormatter<UnitFollowParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitFollowParams value)
		{
			UnitFollowParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitFollowParams value)
		{
			UnitFollowParams.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitFollowParams value)
		{
			UnitFollowParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	[OwlPackInclude]
	[MemoryPackInclude]
	public bool UseOwnSpeed { get; set; }
	...
	public override bool TryMergeInto(AbstractUnitCommand currentCommand)
	{
		...
		unitFollow.Params.UseStraightPath = UseStraightPath;
		unitFollow.Params.ForceMove = ForceMove;
		unitFollow.Params.UseOwnSpeed = UseOwnSpeed;
		return true;
	}
	...
	static UnitFollowParams()
	{
		OwlPackTypeInfo = new TypeInfo
		{
			...
			Fields = new FieldInfo[19]
			{
				...
				new FieldInfo("Destination", typeof(Vector3)),
				new FieldInfo("UseStraightPath", typeof(bool)),
				new FieldInfo("ForceMove", typeof(bool)),
				new FieldInfo("UseOwnSpeed", typeof(bool))
			}
		};
		RegisterFormatter();
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitFollowParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
		...
		Vector3 value7 = value.Destination;
		value3 = value.UseStraightPath;
		value4 = value.ForceMove;
		value6 = value.UseOwnSpeed;
		writer.DangerousWriteUnmanaged(in movementType, in isOneFrameCommand, in slowMotionRequired, in value7, in value3, in value4, in value6);
	}
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitFollowParams? value)
	{
		...
		if (memberCount == 19)
		{
			if (value != null)
			{
				...
				value17 = value.Destination;
				value18 = value.UseStraightPath;
				value19 = value.ForceMove;
				value20 = value.UseOwnSpeed;
				...
				reader.ReadUnmanaged<Vector3>(out value17);
			...
			reader.DangerousReadUnmanaged<WalkSpeedType?, bool?, bool?, Vector3, bool, bool, bool>(out value14, out value15, out value16, out value17, out value18, out value19, out value20);
		}
		else
		{
			if (memberCount > 19)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitFollowParams), 19, memberCount);
				return;
			}
			if (value == null)
			{
		...
		value.Destination = value17;
		value.UseStraightPath = value18;
		value.ForceMove = value19;
		value.UseOwnSpeed = value20;
	}

	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitFollowParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
		...
		writer.WriteProperty("Destination");
		writer.WriteUnmanaged(value.Destination);
		writer.WriteProperty("UseStraightPath");
		writer.WriteUnmanaged(value.UseStraightPath);
		writer.WriteProperty("ForceMove");
		writer.WriteUnmanaged(value.ForceMove);
		writer.WriteProperty("UseOwnSpeed");
		writer.WriteUnmanaged(value.UseOwnSpeed);
		writer.WriteObjectFooter();
	}

	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitFollowParams? value)
	{
		...
		else
		{
			...
			v13 = value.Destination;
			v14 = value.UseStraightPath;
			v15 = value.ForceMove;
			v16 = value.UseOwnSpeed;
		}
		...
		while ((text = reader.ReadPropertyName()) != null)
		{
			if (value == null)
			{
				...
				case "m_SlowMotionRequired":
					...
					break;
				case "Destination":
					reader.ReadUnmanaged<Vector3>(out v13);
					array[15] = true;
					break;
				case "UseStraightPath":
		...
		if (value != null)
		{
			...
			value.Destination = v13;
			value.UseStraightPath = v14;
			value.ForceMove = v15;
			value.UseOwnSpeed = v16;
		}
		else
		{
			value = new UnitFollowParams
	...
	{
		UnitFollowParams source = new UnitFollowParams();
		result = Unsafe.As<UnitFollowParams, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitFollowParams>(OwlPackTypeInfo);
		...
		Vector3 value6 = Destination;
		formatter.Field(15, "Destination", ref value6, state);
		bool value7 = UseStraightPath;
		formatter.UnmanagedField(16, "UseStraightPath", ref value7, state);
		bool value8 = ForceMove;
		formatter.UnmanagedField(17, "ForceMove", ref value8, state);
		bool value9 = UseOwnSpeed;
		formatter.UnmanagedField(18, "UseOwnSpeed", ref value9, state);
		formatter.EndObject();
	}
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitFollowParams>();
		...
		for (int i = 0; i < typeInfo.Fields.Length; i++)
		{
			...
			case 14:
				...
				break;
			case 15:
				Destination = formatter.ReadPackable<Vector3>(state);
				break;
			case 16:
				UseStraightPath = formatter.ReadUnmanaged<bool>(state);
				break;
			case 17:
				ForceMove = formatter.ReadUnmanaged<bool>(state);
				break;
			case 18:
				UseOwnSpeed = formatter.ReadUnmanaged<bool>(state);
				break;
			}
		}
