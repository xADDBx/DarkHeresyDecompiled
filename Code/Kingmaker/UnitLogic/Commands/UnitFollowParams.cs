...
public sealed class UnitFollowParams : UnitCommandParams<UnitFollow>, IOwlPackable<UnitFollowParams>
{
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		formatter.Field(14, "Destination", ref value6, state);
		bool value7 = UseStraightPath;
		formatter.UnmanagedField(15, "UseStraightPath", ref value7, state);
		bool value8 = ForceMove;
		formatter.UnmanagedField(16, "ForceMove", ref value8, state);
		formatter.EndObject();
	}
