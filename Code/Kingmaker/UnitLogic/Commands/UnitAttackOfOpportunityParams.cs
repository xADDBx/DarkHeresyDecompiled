...
public sealed class UnitAttackOfOpportunityParams : UnitUseAbilityParamsAbstract<UnitAttackOfOpportunity>, IOwlPackable<UnitAttackOfOpportunityParams>
{
	[OwlPackInclude]
	[JsonProperty]
	private readonly EntityRef<ItemEntityWeapon> _weapon;
	...
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		...
		Fields = new FieldInfo[21]
		{
			...
			new FieldInfo("_weapon", typeof(EntityRef<ItemEntityWeapon>)),
	...
	[CanBeNull]
	public ItemEntityWeapon Weapon => _weapon;
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		EntityRef<ItemEntityWeapon> value10 = _weapon;
		formatter.Field(19, "_weapon", ref value10, state);
		BlueprintFact value11 = Reason;
		formatter.Field(20, "Reason", ref value11, state);
		formatter.EndObject();
	}
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		for (int i = 0; i < typeInfo.Fields.Length; i++)
		{
			...
			case 18:
				...
				break;
			case 19:
				Unsafe.AsRef(in _weapon) = formatter.ReadPackable<EntityRef<ItemEntityWeapon>>(state);
				break;
			case 20:
