...
public sealed class UnitInterruptTurnParams : UnitCommandParams<UnitInterruptTurn>, IOwlPackable<UnitInterruptTurnParams>
{
	...
	public UnitInterruptTurnParams()
	{
	}

	public static void CreateForDeserialization<TPossiblyBase>(ref TPossiblyBase result)
	{
		UnitInterruptTurnParams source = new UnitInterruptTurnParams();
		result = Unsafe.As<UnitInterruptTurnParams, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitInterruptTurnParams>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitInterruptTurnParams>();
