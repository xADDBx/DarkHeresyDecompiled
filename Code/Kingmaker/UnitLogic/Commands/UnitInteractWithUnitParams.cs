...
public sealed class UnitInteractWithUnitParams : UnitCommandParams<UnitInteractWithUnit>, IMemoryPackable<UnitInteractWithUnitParams>, IMemoryPackFormatterRegister, IOwlPackable<UnitInteractWithUnitParams>
{
	[Preserve]
	private sealed class UnitInteractWithUnitParamsFormatter : MemoryPackFormatter<UnitInteractWithUnitParams>
	{
		[Preserve]
		public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitInteractWithUnitParams value)
		{
			UnitInteractWithUnitParams.Serialize(ref writer, ref value);
		}

		[Preserve]
		public override void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitInteractWithUnitParams value)
		{
			UnitInteractWithUnitParams.SerializeJson(ref writer, ref value);
		}
		...
		[Preserve]
		public override void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitInteractWithUnitParams value)
		{
			UnitInteractWithUnitParams.DeserializeJson(ref reader, ref value);
		}
	}
	...
	static UnitInteractWithUnitParams()
	{
		...
		{
			Name = "UnitInteractWithUnitParams",
			OldNames = null,
			Fields = new FieldInfo[16]
			{
				...
				new FieldInfo("TargetUnit", typeof(EntityRef<AbstractUnitEntity>))
			}
		};
		RegisterFormatter();
	}
	...
	[Preserve]
	public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref UnitInteractWithUnitParams? value) where TBufferWriter : class, IBufferWriter<byte>
	{
		if (value == null)
		{
	...
	public static void Deserialize(ref MemoryPackReader reader, ref UnitInteractWithUnitParams? value)
	{
		...
		bool? value15;
		bool? value16;
		EntityRef<AbstractUnitEntity> value17;
		if (memberCount == 16)
		{
			if (value != null)
			{
			...
			value17 = reader.ReadPackable<EntityRef<AbstractUnitEntity>>();
		}
		else
		{
			if (memberCount > 16)
			{
				MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(UnitInteractWithUnitParams), 16, memberCount);
				return;
			}
			if (value == null)
			{
				...
				value15 = null;
				value16 = null;
				value17 = default(EntityRef<AbstractUnitEntity>);
			}
			else
			{
				value2 = value.Type;
		...
		value.TargetUnit = value17;
	}

	[Preserve]
	public static void SerializeJson(ref MemoryPackJsonWriter writer, ref UnitInteractWithUnitParams? value)
	{
		if (value == null)
		{
			writer.WriteNull();
		...
		writer.WriteProperty("TargetUnit");
		writer.WritePackable(value.TargetUnit);
		writer.WriteObjectFooter();
	}

	[Preserve]
	public static void DeserializeJson(ref MemoryPackJsonReader reader, ref UnitInteractWithUnitParams? value)
	{
		...
		bool? v11;
		bool? v12;
		EntityRef<AbstractUnitEntity> val4;
		if (value == null)
		{
			v = CommandType.None;
			...
			v11 = null;
			v12 = null;
			val4 = default(EntityRef<AbstractUnitEntity>);
		}
		else
		{
			v = value.Type;
		...
		while ((text = reader.ReadPropertyName()) != null)
		{
			if (value == null)
			{
				...
				case "m_SlowMotionRequired":
					...
					break;
				case "TargetUnit":
					val4 = reader.ReadPackable<EntityRef<AbstractUnitEntity>>();
					array[15] = true;
					break;
				}
			}
	...
	{
		UnitInteractWithUnitParams source = new UnitInteractWithUnitParams();
		result = Unsafe.As<UnitInteractWithUnitParams, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<UnitInteractWithUnitParams>(OwlPackTypeInfo);
		...
		EntityRef<AbstractUnitEntity> value6 = TargetUnit;
		formatter.Field(15, "TargetUnit", ref value6, state);
		formatter.EndObject();
	}
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<UnitInteractWithUnitParams>();
		...
		for (int i = 0; i < typeInfo.Fields.Length; i++)
		{
			...
			case 14:
				...
				break;
			case 15:
				TargetUnit = formatter.ReadPackable<EntityRef<AbstractUnitEntity>>(state);
				break;
			}
		}
