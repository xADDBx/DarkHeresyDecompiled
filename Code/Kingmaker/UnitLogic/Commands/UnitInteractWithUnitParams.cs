...
public sealed class UnitInteractWithUnitParams : UnitCommandParams<UnitInteractWithUnit>, IOwlPackable<UnitInteractWithUnitParams>
{
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		formatter.Field(14, "TargetUnit", ref value6, state);
		formatter.EndObject();
	}
