...
public class QAModeExceptionReporter : MonoBehaviour
{
	...
	private static void ShowError(string message, bool addMessageToReport)
	{
		if (BuildModeUtility.IsDevelopment)
		{
			...
			{
				LoadingProcess.Instance.StartLoadingProcess("PauseForError", PauseForError(), null, LoadingProcessTag.ExceptionReporter);
			}
		}
	}
	...
	public static List<(string message, bool addToReport)> GetMessages()
	{
	...
	private void OnGUI()
	{
		...
		{
			s_ReportCanvas = UnityEngine.Object.FindAnyObjectByType<BugReportCanvas>();
		}
