...
public sealed class ElevatorPlatformStopEntity : Entity, IHashable, IOwlPackable<ElevatorPlatformStopEntity>
{
	public static readonly TypeInfo OwlPackTypeInfo = new TypeInfo
	{
		Name = "ElevatorPlatformStopEntity",
		OldNames = null,
	...
	private ElevatorPlatformStopEntity(OwlPackConstructorParameter _)
		: base(_)
	{
	}
	...
	{
		ElevatorPlatformStopEntity source = new ElevatorPlatformStopEntity(default(OwlPackConstructorParameter));
		result = Unsafe.As<ElevatorPlatformStopEntity, TPossiblyBase>(ref source);
	}
	...
	public override void Serialize<TFormatter>(TFormatter formatter, SerializerState state)
	{
		...
		ushort type = state.TypeLibrary.RegisterType<ElevatorPlatformStopEntity>(OwlPackTypeInfo);
	...
	public override void Deserialize<TFormatter>(TFormatter formatter, uint objectId, DeserializerState state)
	{
		...
		TypeInfo typeInfo = state.TypeLibrary.GetTypeInfo<ElevatorPlatformStopEntity>();
