...
public class CustomPortraitsManager
{
	...
	public static string PortraitsRootFolderPath => Path.Combine(ApplicationPaths.persistentDataPath, ConfigRoot.Instance.CharGenRoot.PortraitFolderName);
	...
	{
		return Path.Combine(GetPortraitFolderPath(id), ConfigRoot.Instance.CharGenRoot.PortraitSmallName + ConfigRoot.Instance.CharGenRoot.PortraitsFormat);
	}

	public string GetMediumPortraitPath(string id)
	{
		return Path.Combine(GetPortraitFolderPath(id), ConfigRoot.Instance.CharGenRoot.PortraitMediumName + ConfigRoot.Instance.CharGenRoot.PortraitsFormat);
	}

	public string GetBigPortraitPath(string id)
	{
		return Path.Combine(GetPortraitFolderPath(id), ConfigRoot.Instance.CharGenRoot.PortraitBigName + ConfigRoot.Instance.CharGenRoot.PortraitsFormat);
	}
	...
	public bool EnsureCustomPortraits(string id)
	{
		...
		EnsurePortrait(GetSmallPortraitPath(id), ConfigRoot.Instance.CharGenRoot.BasePortraitSmall);
		EnsurePortrait(GetMediumPortraitPath(id), ConfigRoot.Instance.CharGenRoot.BasePortraitMedium);
		EnsurePortrait(GetBigPortraitPath(id), ConfigRoot.Instance.CharGenRoot.BasePortraitBig);
		return true;
	}
