...
public class GridNavmeshModifier : NavmeshClipper
{
	...
	public override Rect GetBounds(GraphTransform t, float radiusMargin)
	{
		Vector3 point = new Vector3(Bounds.min.x, 0f, Bounds.min.y);
		Vector3 point2 = new Vector3(Bounds.max.x, 0f, Bounds.max.y);
