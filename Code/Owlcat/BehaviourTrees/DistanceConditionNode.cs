...
public class DistanceConditionNode : ConditionNode
{
	...
	public DistanceConditionNode(AbortType abortType, EntityVariable fromVariable, EntityVariable toVariable, FloatVariable distanceVariable, FloatCompareOperator compareOperator)
		: base(abortType)
	{
