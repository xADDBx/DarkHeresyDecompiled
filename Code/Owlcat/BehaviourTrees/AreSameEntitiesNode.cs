...
public class AreSameEntitiesNode : ConditionNode
{
	...
	public AreSameEntitiesNode(AbortType abortType, EntityVariable entity1, EntityVariable entity2, bool invert)
		: base(abortType)
	{
		m_Entity1 = entity1;
		m_Entity2 = entity2;
